                                    ...
                                    <table class="table-bordered mx-auto table-sm">
                                        ...
                                        <tbody>
                                            <tr v-for="(entry, index) in entries" :key="index">
                                                ...
                                                <td>{{ entry.rate }}</td>
                                                <td> <div v-for="(pcs, pcsIndex) in entry.itemss" :key="pcsIndex" class="mb-1">
                                                    {{ pcs.pcs }}-{{ pcs.gross_weight }}-{{ pcs.weight_code }}-{{ pcs.length }}x{{ pcs.width }}x{{ pcs.height }}-{{ pcs.unit }}
                                                    </div>
                                                </td>
                                                ...
                                                <!-- <td>{{ entry.hs_code }}</td> -->
                                                <td> <div v-for="(hs, hsIndex) in entry.hsCodes" :key="hsIndex" class="mb-1">
                                                        {{ hs.hs_code }}
                                                    </div>
                                                </td>
                                                <td>{{ entry.country_origin_goods }}</td>
                                                <td> <div v-for="(uld, uldIndex) in entry.uld_info" :key="uldIndex" class="mb-1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <table class="table-bordered table-sm">
                                                        <thead>
                                                            <tr class="h_background_color">
                                                                <th class="form-control1" style="width: 180px;">Override Issuing Agent:</th>
                                                                <th class="form-control1"></th>
                                                                <th class="form-control1"></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="editable-cell">
                                                                    <input type="text" class="form-control" style="width: 150px" v-model="form.agent_name" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="editable-cell"> Agent Address: </td>
                                                                <td class="editable-cell">
                                                                    <input type="text" class="form-control" style="width: 150px" v-model="form.agent_address" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="editable-cell">
                                                                    <input type="text" class="form-control" style="width: 150px" v-model="form.agent_account" />
                                                                </td>
                                                                <td class="editable-cell">
                                                                    <b-form-checkbox size="sm">Save information for later logins</b-form-checkbox>
                                                                </td>
                                                ...
                                                <div class="col-md-6">
                                                    <table class="table-bordered table-sm">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="editable-cell">
                                                                    <b-form-radio name="participate" size="sm" v-model="form.participate" value="0">Participant</b-form-radio>
                                                                </td>
                                                                <td class="editable-cell">
                                                                    <b-form-radio name="office" size="sm" v-model="form.participate" value="1">Office</b-form-radio>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="editable-cell">Participant Airport:</td>
                                                                <td class="editable-cell">
                                                                    <b-form-select class="form-control" style="width: 150px" v-model="form.participate_airport">
                                                                        <option disabled value=""> Please select one </option>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="editable-cell px-4">
                                                                <input type="text" class="form-control" style="width: 330px;" v-model="form.oci_supplementary_info" :class="{ 'is-invalid': form.errors.has('oci_supplementary_info') }"/>
...
export default {
    ...
    methods: {
        ...
        saveAll() {
            ...
            formData.append('consignee_info', JSON.stringify(this.entries));
        ...
        addOrUpdateEntry() {
            const entry = {
                ...
                rate_class: this.form.rate_class,
                total_amount: this.form.total_amount,
                rate_class: this.form.rate_class,
                uld_rate_class: this.form.uld_rate_class,
                service_code: this.form.service_code,
                commodity_item: this.form.commodity_item,
                country_origin_goods: this.form.country_origin_goods,
                slac: this.form.slac,
                gross_weight: this.form.gross_weight,
                weight_code: this.form.weight_code,
                chargable_weight: this.form.chargable_weight,
                rate: this.form.rate,
                hsCodes: this.hsCodes,
                itemss: this.itemss, 
                uld_info:this.uld_info
                // hsCodes: [...this.hsCodes],
                // itemss: [...this.itemss], 
                // uld_info: [...this.uld_info]
            };
            // if (this.editIndex !== null) {
            // this.entries[this.editIndex] = { ...this.form, hsCodes: [...this.hsCodes], itemss: [...this.itemss], uld_info: [...this.uld_info] };
            // } else {
            // this.entries.push({ ...this.form, hsCodes: [...this.hsCodes], itemss: [...this.itemss], uld_info: [...this.uld_info] });
            // }
            if (this.editIndex !== null) {
        ...
        addHsCode() {
            if (this.form.hs_code){
                this.hsCodes.push({
                    hs_code: this.form.hs_code
                });
            this.form.hs_code = "";
            }
            else {
