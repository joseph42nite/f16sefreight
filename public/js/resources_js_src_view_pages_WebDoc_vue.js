...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      this.form.post("/create-webdoc").then(function (_ref) {
        var data = _ref.data;
