...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getAirwayBills(status) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get(`/user/get-airway-bills/${status}`).then(response => {
    ...
    reloadPageWithContent() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get(`/user/airway-bill/${awbId}`).then(response => {
        this.existingData = response.data;
