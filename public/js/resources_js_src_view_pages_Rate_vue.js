...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    get_asm: function get_asm() {
      var _this3 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].get("/user/get-ams").then(function (_ref3) {
        var data = _ref3.data;
        for (var i = 0; i < data.length; i++) {
    ...
    get_rate: function get_rate() {
      ...
      var items_loop = [];
      var rate_index = 3;
      this.search_form.post("/user/get-rate").then(function (_ref4) {
        var data = _ref4.data;
      ...
      if (confirm("This rate can be wrong. confirm it from official website")) {
        ...
        if (arr_len) {
          for (var i in this.rate_data_copy) {
            ...
            currentData.Airline = "".concat(carrier_code, "(").concat(this.rate_data_copy[i].carrier_prefix, ")");
            currentData.ProductType = this.rate_data_copy[i].product_name;
            currentData.Quantity = "".concat(Object.keys(this.rate_data_copy[i].my_rate)[0]);
            currentData.Price = "".concat(this.rate_data_copy[i].my_rate_2[Object.keys(this.rate_data_copy[i].my_rate_2)[0]], "++, Surcharges:");
            if (carrier_code == 'EK') {
              if (this.all_ams_ek[this.searched_country_code].fsc) currentData.Price += "".concat(this.all_ams_ek[this.searched_country_code].fsc, " (FCS)");
              if (this.all_ams_ek[this.searched_country_code].misc) currentData.Price += " + ".concat(this.all_ams_ek[this.searched_country_code].misc, " (MISC)");
              if (this.all_ams_ek[this.searched_country_code].xray) currentData.Price += " + ".concat(this.all_ams_ek[this.searched_country_code].xray, " (XRAY)");
              if (this.all_ams_ek[this.searched_country_code].scc) currentData.Price += " + ".concat(this.all_ams_ek[this.searched_country_code].scc, " (SCC)");
              if (this.all_ams_ek[this.searched_country_code].ctg) currentData.Price += " + ".concat(this.all_ams_ek[this.searched_country_code].ctg, " (CTG)");
              if (this.all_ams_ek[this.searched_country_code].awb_fee) currentData.Price += " + ".concat(this.all_ams_ek[this.searched_country_code].awb_fee, " (AWB FEE)");
              if (this.all_ams_ek[this.searched_country_code].mawb) currentData.Price += ", AMS: ".concat(this.all_ams_ek[this.searched_country_code].mawb, " (MAWB) +");
              if (this.all_ams_ek[this.searched_country_code].hawb) currentData.Price += "".concat(this.all_ams_ek[this.searched_country_code].hawb, " (HAWB)");
              ...
              if (main_key) {
                if (this.all_ams_tg_cx[main_key].fsc) currentData.Price += "".concat(this.all_ams_tg_cx[main_key].fsc, " (FCS)");
                if (this.all_ams_tg_cx[main_key].misc) currentData.Price += " + ".concat(this.all_ams_tg_cx[main_key].misc, " (MISC)");
                if (this.all_ams_tg_cx[main_key].xray) currentData.Price += " + ".concat(this.all_ams_tg_cx[main_key].xray, " (XRAY)");
                if (this.all_ams_tg_cx[main_key].scc) currentData.Price += " + ".concat(this.all_ams_tg_cx[main_key].scc, " (SCC)");
                if (this.all_ams_tg_cx[main_key].ctg) currentData.Price += " + ".concat(this.all_ams_tg_cx[main_key].ctg, " (CTG)");
                if (this.all_ams_tg_cx[main_key].awb_fee) currentData.Price += " + ".concat(this.all_ams_tg_cx[main_key].awb_fee, " (AWB FEE)");
                if (this.all_ams_tg_cx[main_key].mawb) currentData.Price += ", AMS: ".concat(this.all_ams_tg_cx[main_key].mawb, " (MAWB) +");
                if (this.all_ams_tg_cx[main_key].hawb) currentData.Price += "".concat(this.all_ams_tg_cx[main_key].hawb, " (HAWB)");
              }
            } else {
              if (this.all_ams[carrier_code].fsc) currentData.Price += "".concat(this.all_ams[carrier_code].fsc, " (FCS)");
              if (this.all_ams[carrier_code].misc) currentData.Price += " + ".concat(this.all_ams[carrier_code].misc, " (MISC)");
              if (this.all_ams[carrier_code].xray) currentData.Price += " + ".concat(this.all_ams[carrier_code].xray, " (XRAY)");
              if (this.all_ams[carrier_code].scc) currentData.Price += " + ".concat(this.all_ams[carrier_code].scc, " (SCC)");
              if (this.all_ams[carrier_code].ctg) currentData.Price += " + ".concat(this.all_ams[carrier_code].ctg, " (CTG)");
              if (this.all_ams[carrier_code].awb_fee) currentData.Price += " + ".concat(this.all_ams[carrier_code].awb_fee, " (AWB FEE)");
              if (this.all_ams[carrier_code].mawb) currentData.Price += ", AMS: ".concat(this.all_ams[carrier_code].mawb, " (MAWB) +");
              if (this.all_ams[carrier_code].hawb) currentData.Price += "".concat(this.all_ams[carrier_code].hawb, " (HAWB)");
            }
      ...
      for (var i = 0; i < this.rate_data.length; i++) {
        ...
        if (parseInt(this.last_extra_comission) > 0) {
          if (this.profit_type == "total") {
            var add_profit = parseInt(this.last_extra_comission) / parseInt(this.search_form.quantity);
        ...
        if (parseInt(this.extra_comission) > 0) {
          if (this.profit_type == "total") {
            var _add_profit = parseInt(this.extra_comission) / parseInt(this.search_form.quantity);
            this.rate_data[i].my_rate_2[obj_key] = parseInt(this.rate_data[i].my_rate_2[obj_key]) + parseInt(_add_profit);
          } else if (this.profit_type == "per_kg") {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapGetters)({
    ...
    filteredLocations_from: function filteredLocations_from() {
      ...
      var query = this.searchQuery_from.toLowerCase();
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      click: function click($event) {
        _vm.report_popup = true;
      }
    }
  }, [_vm._v("Report here")])]), _vm._v(" "), _c("div", {
    ...
    ref: "dropdownContainer_from",
    staticClass: "custom-dropdown",
    on: {
      click: _vm.toggleDropdown_from
    }
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.searchQuery_from,
      expression: "searchQuery_from"
    }],
    ...
    on: {
      input: function input($event) {
        ...
        _vm.searchQuery_from = $event.target.value;
      }
    }
  }), _vm._v(" "), _vm.isDropdownOpen_from ? _c("div", {
    staticClass: "dropdown-options"
  }, _vm._l(_vm.filteredLocations_from, function (item, index) {
    return _c("div", {
      key: index,
      staticClass: "option",
      on: {
        click: function click($event) {
          return _vm.selectOption_from(item);
        }
      }
  ...
  }, [_vm._v("Weight in kg")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }, [_vm._v("Weights Type")]), _vm._v(" "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    "class": _vm.is_all_rate ? "col-12 col-md-12" : "col-12 col-md-8"
  }, [_c("div", {
    staticClass: "rate-area mr-1"
  }, [!_vm.is_all_rate ? _c("span", {
    staticClass: "copy-cls",
    on: {
      click: function click($event) {
        return _vm.copyToClipboard();
      }
    }
  }, [_vm._v("Export")]) : _vm._e(), _vm._v(" "), !_vm.is_all_rate ? _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }, [_vm._v("Total profit")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "per_kg"
    }
  }, [_vm._v("-/kg")])]) : _vm._e(), _vm._v(" "), _vm.is_all_rate ? _c("vue-excel-xlsx", {
    attrs: {
      data: _vm.items,
      columns: _vm.fields,
      "file-name": "rate",
  ...
  }, [_vm._v("\n                            Export rate\n                        ")])]) : _vm._e(), _vm._v(" "), _vm.is_all_rate ? _c("b-table", {
    staticStyle: {
      "white-space": "nowrap"
    },
    attrs: {
    ...
    staticClass: "table"
  }, [_c("thead", [_c("tr", [_c("th", [_vm._v("#")]), _vm._v(" "), _c("th", [_vm._v("Airline")]), _vm._v(" "), _c("th", [_vm._v("Product Type")]), _vm._v(" "), _c("th", [_vm._v("Quantity")]), _vm._v(" "), _c("th", [_vm._v("Price")]), _vm._v(" "), _c("th", [_vm._v("Added Profit")])])]), _vm._v(" "), _c("tbody", _vm._l(_vm.rate_data, function (rate, index) {
    return _c("tr", {
      key: index
    }, [_c("td", [_c("input", {
      attrs: {
    ...
    })]), _vm._v(" "), _c("td", [_vm._v("\n                                    " + _vm._s(rate.carrier_code + "(" + rate.carrier_prefix + ")") + "\n                                ")]), _vm._v(" "), _c("td", [_vm._v(_vm._s(rate.product_name))]), _vm._v(" "), _c("td", [_vm._v("\n                                    " + _vm._s(Object.keys(rate.my_rate)[0]) + "\n                                ")]), _vm._v(" "), _c("td", [_vm._v("\n                                    " + _vm._s(rate.my_rate[Object.keys(rate.my_rate)[0]]) + "\n                                ")]), _vm._v(" "), _c("td", {
      staticStyle: {
        color: "#ee5253"
      }
    }, [_vm._v("\n                                    " + _vm._s(rate.my_rate_2[Object.keys(rate.my_rate_2)[0]]) + "\n                                ")])]);
  }), 0)])], 1)]), _vm._v(" "), !_vm.is_all_rate ? _c("div", {
    staticClass: "col-12 col-md-4"
  }, [_c("div", {
    staticClass: "rate-area ml-1"
  }, [_c("div", [_c("span", [_vm._v("FSC : "), _c("span", [_vm._v(_vm._s(_vm.ams_arr.fsc))])]), _c("br"), _vm._v(" "), _c("span", [_vm._v("SCC : "), _c("span", [_vm._v(_vm._s(_vm.ams_arr.scc))])]), _c("br"), _vm._v(" "), _c("span", [_vm._v("XRAY : "), _c("span", [_vm._v(_vm._s(_vm.ams_arr.xray))])]), _c("br"), _vm._v(" "), _c("span", [_vm._v("MISC : "), _c("span", [_vm._v(_vm._s(_vm.ams_arr.misc))])]), _c("br"), _vm._v(" "), _c("span", [_vm._v("CTG : "), _c("span", [_vm._v(_vm._s(_vm.ams_arr.ctg))])]), _c("br"), _vm._v(" "), _c("span", [_vm._v("AWB FEE : "), _c("span", [_vm._v(_vm._s(_vm.ams_arr.awb_fee))])]), _c("br"), _vm._v(" "), _c("span", [_vm._v("MAWB : "), _c("span", [_vm._v(_vm._s(_vm.ams_arr.mawb))])]), _c("br"), _vm._v(" "), _c("span", [_vm._v("HAWB : "), _c("span", [_vm._v(_vm._s(_vm.ams_arr.hawb))])]), _c("br")]), _vm._v(" "), _c("hr"), _vm._v(" "), _vm.user_notice ? _c("div", {
    staticClass: "d-flex"
  }, [_c("h4", {
    staticClass: "text-danger"
  }, [_vm._v("Notice:")]), _c("span", [_vm._v(_vm._s(_vm.user_notice))])]) : _vm._e()])]) : _vm._e()])]), _vm._v(" "), _c("b-modal", {
    attrs: {
      id: "login-modal",
      "hide-footer": true
    },
    ...
    staticClass: "btn font-weight-bolder btn-primary py-3",
    on: {
      click: function click($event) {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Rate_vue_vue_type_style_index_0_id_511055dc_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Rate.vue?vue&type=style&index=0&id=511055dc&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/Rate.vue?vue&type=style&index=0&id=511055dc&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Rate_vue_vue_type_style_index_0_id_511055dc_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Rate_vue_vue_type_template_id_511055dc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Rate.vue?vue&type=template&id=511055dc& */ "./resources/js/src/view/pages/Rate.vue?vue&type=template&id=511055dc&");
/* harmony import */ var _Rate_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Rate.vue?vue&type=script&lang=js& */ "./resources/js/src/view/pages/Rate.vue?vue&type=script&lang=js&");
/* harmony import */ var _Rate_vue_vue_type_style_index_0_id_511055dc_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Rate.vue?vue&type=style&index=0&id=511055dc&lang=css& */ "./resources/js/src/view/pages/Rate.vue?vue&type=style&index=0&id=511055dc&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Rate_vue_vue_type_template_id_511055dc___WEBPACK_IMPORTED_MODULE_0__.render,
  _Rate_vue_vue_type_template_id_511055dc___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Rate_vue_vue_type_template_id_511055dc___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Rate_vue_vue_type_template_id_511055dc___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Rate_vue_vue_type_template_id_511055dc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Rate.vue?vue&type=template&id=511055dc& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/Rate.vue?vue&type=template&id=511055dc&");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Rate_vue_vue_type_style_index_0_id_511055dc_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Rate.vue?vue&type=style&index=0&id=511055dc&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/Rate.vue?vue&type=style&index=0&id=511055dc&lang=css&");
