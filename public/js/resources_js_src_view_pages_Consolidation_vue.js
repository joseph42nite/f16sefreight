  ...
  methods: {
    ...
    searchWayBills: function searchWayBills() {
      ...
      this.form.post('/user/search-house-way-bills', {
        ...
        if (response.data && response.data.length) {
          var id = "".concat(String(_this3.form.awb_code)).concat(String(_this3.form.awb_no));
    ...
    updateHouseWayBill: function updateHouseWayBill() {
      ...
      this.form.put("/user/update-consolidation/".concat(this.form.id), updateData).then(function (response) {
        _this5.$bvToast.toast('House waybill updated successfully', {
          title: 'Success',
          variant: 'success',
          solid: true,
          autoHideDelay: 3000
        ...
        _this5.searchWayBills();
        // Clear the form
        _this5.clearForm();
      })["catch"](function (error) {
        console.error("Error updating house waybill:", error);
        _this5.$bvToast.toast('Error updating house waybill. Please try again.', {
          title: 'Error',
          variant: 'danger',
          solid: true,
          autoHideDelay: 5000
    ...
    getAgent: function getAgent() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get("/user/agent-info/").then(function (_ref3) {
        ...
        if (Array.isArray(data) && data.length > 0) {
          _this7.agent_information = data[0];
          _this7.iata_cass = {
            iata_agent_code: _this7.agent_information.iata_agent_code || null,
            iata_agent_cass: _this7.agent_information.iata_agent_cass || null
          };
        } else {
          _this7.agent_information = data;
        }
      })["catch"](function (error) {
    ...
    getOCIData: function getOCIData() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get('/user/get-oci-data').then(function (_ref4) {
        ...
        if (data && data.oci_custom_info_identifier) {
          _this8.oci_data.oci_custom_info_identifier = Object.entries(data.oci_custom_info_identifier).map(function (_ref5) {
          ...
          _this8.oci_data.oci_custom_info_identifier = [];
        }
        if (data && data.identifiers) {
          _this8.oci_identifiers.identifiers = Object.entries(data.identifiers).map(function (_ref7) {
    ...
    getHouseWayBill: function getHouseWayBill(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get("/user/houseway-bill/".concat(id)).then(function (response) {
        ...
        _this9.openForm('update', String(_this9.existingData.id));
...
var render = function render() {
  ...
  }, [_vm._v("Nature of Goods")])])])]), _vm._v(" "), _vm.consolidation && _vm.consolidation.length > 0 ? _vm._l(_vm.consolidation, function (waybill, index) {
    return _c("div", {
      key: index,
      staticClass: "d-flex",
      staticStyle: {
  ...
  }, [_vm._v("No house waybills found for this master AWB.")])]) : _vm._e()], 1)], 1)], 1)]);
};
var staticRenderFns = [];
render._withStripped = true;
