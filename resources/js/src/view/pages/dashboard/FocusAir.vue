                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div v-if="is_generate_pdf" class="mb-24" style="box-shadow: 0px 3px 15px 0px #0013;border-radius: 12px;width: 100%;">
                                            ...
                                            <div class="mb-16" style="width:96%;margin-left: 2%;margin-right: 2%;">
                                                <a href="#" style="width:fit-content;" class="custom-link mb-0" @click.prevent="handleSaveAndGeneratePDF('download-awb-pdf')">
                                                    <p class="mb-0 ml-2">e-AWB Pdf file</p>
                                                </a>
                                                <a href="#" style="width:fit-content;" class="custom-link mb-0" @click.prevent="handleSaveAndGeneratePDF('download-multiple-awb-pdf')">
                                                    <p class="mb-0 ml-2">Multipage e-AWB Pdf</p>
                                                </a>
                                                <a href="#" style="width:fit-content;" class="custom-link mb-0" @click.prevent="handleSaveAndGeneratePDF('download-multiple-both-page-awb-pdf')">
...
.dropdown-options {
    ...
    border-radius: 12px;
    box-shadow: 0px 10px 30px rgba(53, 85, 148, 0.15);
