...
-   **Step 3.1:** Create `JobController.php` containing store triage, confirmTask, markLost, and `reclassifyThread` override actions (handling manual re-classification promotions/demotions between alerts and job records).
