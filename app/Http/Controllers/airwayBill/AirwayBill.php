...
class AirwayBill extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make([
            ...
            'consignee_info' => 'nullable|array',
            'consignee_info.*.pieces' => 'nullable|digits_between:1,4',
            'consignee_info.*.description' => 'nullable|string|max:70',
            'consignee_info.*.rate_class' => 'nullable|string|max:1',
            'consignee_info.*.uld_rate_class' => 'nullable|regex:/^\d[A-Za-z]{2}$/',
            'consignee_info.*.service_code' => 'nullable|string|max:1',
            'consignee_info.*.commodity_item' => 'nullable|regex:/^[a-zA-Z0-9\s]+$/|max:11',
            'consignee_info.*.country_origin_goods' => 'nullable|string|max:2',
            'consignee_info.*.slac' => 'nullable|string',
            'consignee_info.*.hsCode' => 'nullable|array',
            'consignee_info.*.hsCode.*.hs_code' => 'required|regex:/^[a-zA-Z0-9\s]+$/|min:6|max:18',
            'consignee_info.*.gross_weight' => 'nullable|numeric|min:0.1|max:9999999',
            'consignee_info.*.chargable_weight' => 'nullable|numeric|min:0.1|max:9999999',
            'consignee_info.*.weight_code' => 'nullable|string|max:3',
            'consignee_info.*.rate' => 'nullable|numeric|min:0.0001|max:99999999',
            'consignee_info.*.height' => 'nullable|regex:/^[0-9]+$/|max:5',
            'consignee_info.*.width' => 'nullable|regex:/^[0-9]+$/|max:5',
            'consignee_info.*.length' => 'nullable|regex:/^[0-9]+$/|max:5',
            'consignee_info.*.unit' => 'nullable|string|max:3',
            'consignee_info.*.volume' => 'nullable|string',
            'consignee_info.*.dimention_unit' => 'nullable|string|max:2',
            'consignee_info.*.total_volume' => 'nullable|regex:/^[0-9]+$/|max:9',
            'consignee_info.*.total_amount' => 'nullable|numeric|min:0.01|max:999999999',
            'consignee_info.*.uld_info' => 'nullable|array',
            'consignee_info.*.uld_info.*.uld_type' => 'nullable|string|size:3',
            'consignee_info.*.uld_info.*.uld_serial' => 'nullable|regex:/^[a-zA-Z0-9\s]+$/|max:5',
            'consignee_info.*.uld_info.*.owner' => 'nullable|regex:/^[a-zA-Z0-9\s]+$/|size:2',
