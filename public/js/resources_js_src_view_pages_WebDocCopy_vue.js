    ...
    handleFileSelect: function handleFileSelect(event) {
      ...
      if (upload_file) {
        ...
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].post('/user/upload-awb-file', formData, {
          ...
          var _response$data, _routing$transit_airp, _routing$transit_airp2, _routing$flights, _routing$flights$0$fl, _routing$flights2, _routing$flights2$0$f, _routing$flights3, _routing$flights4, _routing$flights4$1$f, _routing$flights5, _routing$flights5$1$f, _routing$flights6;
          ...
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].post("/user/get-airport-by-airport-code", {
            ...
            var _response2$data, _response, _response2, _response3, _response4;
            ...
            _this.form.routing_information.to = "".concat((_response = response2) === null || _response === void 0 ? void 0 : _response[2]['iata_code'], ", ").concat((_response2 = response2) === null || _response2 === void 0 ? void 0 : _response2[2]['destination']);
            _this.form.routing_information.to_2 = "".concat((_response3 = response2) === null || _response3 === void 0 ? void 0 : _response3[3]['iata_code'], ", ").concat((_response4 = response2) === null || _response4 === void 0 ? void 0 : _response4[3]['destination']);
          });
          _this.form.routing_information.by = (_routing$flights = routing.flights) === null || _routing$flights === void 0 ? void 0 : (_routing$flights$0$fl = _routing$flights[0].flight_code) === null || _routing$flights$0$fl === void 0 ? void 0 : _routing$flights$0$fl.slice(0, 2);
          _this.form.routing_information.flight = (_routing$flights2 = routing.flights) === null || _routing$flights2 === void 0 ? void 0 : (_routing$flights2$0$f = _routing$flights2[0].flight_code) === null || _routing$flights2$0$f === void 0 ? void 0 : _routing$flights2$0$f.slice(2);
          _this.form.routing_information.date = (_routing$flights3 = routing.flights) === null || _routing$flights3 === void 0 ? void 0 : _routing$flights3[0].date;
          _this.form.routing_information.by_2 = (_routing$flights4 = routing.flights) === null || _routing$flights4 === void 0 ? void 0 : (_routing$flights4$1$f = _routing$flights4[1].flight_code) === null || _routing$flights4$1$f === void 0 ? void 0 : _routing$flights4$1$f.slice(0, 2);
          _this.form.routing_information.flight_2 = (_routing$flights5 = routing.flights) === null || _routing$flights5 === void 0 ? void 0 : (_routing$flights5$1$f = _routing$flights5[1].flight_code) === null || _routing$flights5$1$f === void 0 ? void 0 : _routing$flights5$1$f.slice(2);
          _this.form.routing_information.date_2 = (_routing$flights6 = routing.flights) === null || _routing$flights6 === void 0 ? void 0 : _routing$flights6[1].date;
