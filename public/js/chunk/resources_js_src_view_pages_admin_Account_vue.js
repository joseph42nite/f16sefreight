...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    onSubmit() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].put(`/superadmin/upadte-detail`, this.user_form).then(({
        data
      }) => {
    ...
    submitPassword() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].put(`/superadmin/update-password`, this.password_form).then(({
        data
      }) => {
        this.$store.dispatch(_core_services_store_auth_module__WEBPACK_IMPORTED_MODULE_1__.LOGOUT).then(() => this.$router.push('/login'));
      }).catch(err => {
