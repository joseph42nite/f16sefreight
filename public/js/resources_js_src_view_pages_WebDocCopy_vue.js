...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: (_methods = {
    ...
    if (this.mode === 'add') {
      ...
      this.form.post("/user/create-webdoc").then(function (response) {
        $('.submit-button').css({
          'pointer-events': 'auto',
          'opacity': '1'
        });
        if (response.data && response.data.data.first_box && response.data.data.first_box.original && response.data.data.first_box.original.data && response.data.data.first_box.original.data.id) {
          _this10.existingData = response.data.data.first_box.original.data;
          if (_this10.generatePDFAfterSave && _this10.existingData && _this10.existingData.id) {
            _this10.generateAwbPDF(_this10.generatePDFAfterSave);
          }
          _this10.successMessage = '-e-AWB Saved in database -Pass';
        } else {}
      })["catch"](function (error) {
        $('.submit-button').css({
          'pointer-events': 'auto',
        ...
        _this10.main_error_msg = main_error_msg;
      });
  ...
  }), _defineProperty(_methods, "getAirwayBills", function getAirwayBills(status) {
    var _this11 = this;
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-airway-bills/".concat(status)).then(function (response) {
      _this11.data_items = response.data;
      // console.log('Data items:', this.data_items);
    })["catch"](function (error) {
      // console.error("Failed to fetch items:", error);
    });
  }), _defineProperty(_methods, "getAirWayBill", function getAirWayBill(id) {
    var _this12 = this;
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/airway-bill/".concat(id)).then(function (response) {
      if (response.data && response.data.id == id) {
        _this12.existingData = response.data;
        _this12.existingData.payment_info = _objectSpread(_objectSpread({}, _this12.defaultPaymentInfo), _this12.existingData.payment_info || {});
        // this.setDefaultValues();
        _this12.showAWBSection = true;
        _this12.awbError = null;
        _this12.openForm('update', _this12.existingData.id);
        if (_this12.existingData && _this12.existingData.consignment_data) {
          _this12.isConsignmentAdded = true;
        }
      } else {
        _this12.showAWBSection = false; // Hide if no data exists
        _this12.awbError = "No data found for this AWB ID.";
      }
    })["catch"](function (error) {
      _this12.existingData = null;
      _this12.showAWBSection = false;
      _this12.awbError = "No data found for this AWB ID.";
      _this12.awbDetails = false;
    });
  }), _defineProperty(_methods, "getAirWayBillForRealod", function getAirWayBillForRealod(id) {
    var _this13 = this;
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/airway-bill/".concat(id)).then(function (response) {
      var _response$data2, _response$data2$id;
      var fetchedId = (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : (_response$data2$id = _response$data2.id) === null || _response$data2$id === void 0 ? void 0 : _response$data2$id.toString();
      var inputId = id.toString();
      if (fetchedId === inputId) {
        _this13.existingData = response.data;
        _this13.showAWBSection = true;
        _this13.awbError = null;
        // this.openForm('update', this.existingData.id);
      } else {
        _this13.existingData = null;
        _this13.showAWBSection = false;
        _this13.awbError = "No data found for this AWB ID.";
      }
    })["catch"](function (error) {
      var _error$response;
      // console.error("Error fetching AWB:", error.response || error);
      _this13.showAWBSection = false;
      _this13.awbError = ((_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 404 ? "Air Waybill not found." : "";
    });
  ...
  }), _defineProperty(_methods, "handleEditNavigation", function handleEditNavigation(id) {
  ...
  }), _defineProperty(_methods, "getAgent", function getAgent(company_id, branch_id) {
    var _this14 = this;
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/agent-info").then(function (_ref7) {
      var data = _ref7.data;
      if (Array.isArray(data) && data.length > 0) {
        _this14.agent_information = data[0];
        _this14.iata_cass = {
          iata_agent_code: _this14.agent_information.iata_agent_code || null,
          iata_agent_cass: _this14.agent_information.iata_agent_cass || null
        };
      } else {
        _this14.agent_information = data;
      }
    })["catch"](function (error) {
    ...
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/user/get-country').then(function (_ref8) {
      var data = _ref8.data;
      _this15.countries = Object.keys(data).map(function (key) {
        return {
          value: key,
          text: data[key]
        };
    ...
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/user/other-charges').then(function (_ref9) {
      var data = _ref9.data;
      _this16.other_charges_code = Object.keys(data).map(function (key) {
        return {
          value: key,
          text: data[key]
        };
    ...
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/user/get-oci-data').then(function (_ref10) {
      ...
      if (data && data.oci_custom_info_identifier) {
        _this17.oci_data.oci_custom_info_identifier = Object.entries(data.oci_custom_info_identifier).map(function (_ref11) {
        ...
        _this17.oci_data.oci_custom_info_identifier = [];
      }
      if (data && data.identifiers) {
        _this17.oci_identifiers.identifiers = Object.entries(data.identifiers).map(function (_ref13) {
  ...
  }), _defineProperty(_methods, "handleRadioChange", function handleRadioChange(value) {
    ...
    this.consignment_list.post("/user/get-consignment-error").then(function (response) {
      ...
      var updatedEntry = _objectSpread(_objectSpread({}, _this18.consignment_list), {}, {
        uld_info: JSON.stringify(_this18.consignment_list.uld_infos),
        pieces_info: JSON.stringify(_this18.consignment_list.itemss),
        hs_code: JSON.stringify(_this18.consignment_list.hsCodes)
      });
      if (_this18.edit_entry_index !== null) {
        // console.log("Updating entry at index", this.edit_entry_index, "with data:", updatedEntry);
        _this18.form.entries[_this18.edit_entry_index] = updatedEntry;
        ...
        _this18.edit_entry_index = null;
      } else {
        // console.log("Adding new entry:", updatedEntry);
        _this18.form.entries.push(updatedEntry);
        // console.log("Adding new entry:", this.consignment_list);
        // this.form.entries.push({ ...this.consignment_list });
      }

      _this18.calculateTotalVolume();
      _this18.calculateTotalAmount();
      _this18.isConsignmentAdded = _this18.form.entries.length > 0;
      _this18.closeModal();
      // console.log("Updated form entries:", this.form.entries);
      //clear consignment_list data
      for (var key in _this18.consignment_list) {
        if (key != 'busy' && key != 'successful' && key != 'errors' && key != 'originalData') {
          if (_typeof(_this18.consignment_list[key]) === 'object') {
            _this18.consignment_list[key] = [];
          } else {
            _this18.consignment_list[key] = '';
          }
        }
    ...
    var totalVolume = this.form.entries.reduce(function (total, entry) {
      return total + entry.itemss.reduce(function (entryTotal, item) {
        ...
        var selectedUnit = _this19.form.totals.dimention_unit;
        var finalVolume = 0;
        switch (selectedUnit) {
          case 'CMQ':
            // cm³
    ...
    Object.keys(rules).forEach(function (field) {
      ...
      var value = _this20.consignment_list[field];
      if (value) {
        if (rule.type === 'numeric' && (isNaN(value) || value < rule.min || value > rule.max)) {
          _this20.validationErrors.push(rule.message);
  ...
  }), _defineProperty(_methods, "toggleDropdown_participant_airport", function toggleDropdown_participant_airport() {
    this.isDropdownOpen_participant = !this.isDropdownOpen_participant;
  }), _defineProperty(_methods, "selectOption_participant_airport", function selectOption_participant_airport(item) {
  ...
  }), _defineProperty(_methods, "closeDropdown_participant_airport", function closeDropdown_participant_airport(event) {
  ...
  }), _defineProperty(_methods, "onAWBInput", lodash_debounce__WEBPACK_IMPORTED_MODULE_4___default()(function () {
    var _this21 = this;
    ...
    if (awb_code && awb_code.length === 3) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-awbcode-prefix/".concat(awb_code)).then(function (response) {
        if (response.data) {
          ...
          _this21.awb_prefix_message = "Message will be sent to ".concat(name, " (").concat(code, ")");
        } else {
          _this21.awb_prefix_message = "No agreement found for: ".concat(awb_code, " You will not be able to send the message to this carrier - only generate a PDF.");
        }
      })["catch"](function (error) {
  ...
  }, 500)), _defineProperty(_methods, "confirmReload", function confirmReload() {
  ...
  }), _defineProperty(_methods, "reloadPageWithContent", function reloadPageWithContent() {
    var _this22 = this;
    ...
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/airway-bill/".concat(awbId)).then(function (response) {
      _this22.existingData = response.data;
      if (_this22.existingData) {
        _this22.awbDetails = false;
        _this22.openForm('update', _this22.existingData.id);
        // this.$router.push({ path: `/edit-airway-bill/${awbId}`});
        _this22.location.reload();
        // this.$router.push({ path: `/edit-airway-bill/${awbId}` });
      } else {
        _this22.awbDetails = false;
      }
    })["catch"](function (error) {
      _this22.existingData = null;
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapGetters)({
    ...
    filteredLocations_to: function filteredLocations_to() {
      var _this$form, _this$form$routing_in;
      var query = (((_this$form = this.form) === null || _this$form === void 0 ? void 0 : (_this$form$routing_in = _this$form.routing_information) === null || _this$form$routing_in === void 0 ? void 0 : _this$form$routing_in.to) || '').toLowerCase().trim();
    ...
    filteredLocations_to2: function filteredLocations_to2() {
      var _this$form2, _this$form2$routing_i;
      var query = (((_this$form2 = this.form) === null || _this$form2 === void 0 ? void 0 : (_this$form2$routing_i = _this$form2.routing_information) === null || _this$form2$routing_i === void 0 ? void 0 : _this$form2$routing_i.to_2) || '').toLowerCase().trim();
      if (!query) return this.location;
      return this.location.filter(function (item) {
        return item.iata_code.toLowerCase().includes(query);
      });
    ...
    filteredLocations_to3: function filteredLocations_to3() {
      var _this$form3, _this$form3$routing_i;
      var query = (((_this$form3 = this.form) === null || _this$form3 === void 0 ? void 0 : (_this$form3$routing_i = _this$form3.routing_information) === null || _this$form3$routing_i === void 0 ? void 0 : _this$form3$routing_i.to_3) || '').toLowerCase().trim();
      if (!query) return this.location;
      return this.location.filter(function (item) {
        return item.iata_code.toLowerCase().includes(query);
      });
    ...
    filteredLocations_from: function filteredLocations_from() {
      var _this$form4, _this$form4$routing_i;
      ...
      //     item.iata_code.toLowerCase().includes(query)
      // );
      var query = (((_this$form4 = this.form) === null || _this$form4 === void 0 ? void 0 : (_this$form4$routing_i = _this$form4.routing_information) === null || _this$form4$routing_i === void 0 ? void 0 : _this$form4$routing_i.from) || '').toLowerCase().trim();
      if (!query) return this.location;
      return this.location.filter(function (item) {
        return item.iata_code.toLowerCase().includes(query);
      });
    ...
    filteredLocations_destination: function filteredLocations_destination() {
      var _this$form5, _this$form5$routing_i;
      ...
      //     item.iata_code.toLowerCase().includes(query)
      // );
      var query = (((_this$form5 = this.form) === null || _this$form5 === void 0 ? void 0 : (_this$form5$routing_i = _this$form5.routing_information) === null || _this$form5$routing_i === void 0 ? void 0 : _this$form5$routing_i.destination_airport) || '').toLowerCase().trim();
      if (!query) return this.location;
      return this.location.filter(function (item) {
        return item.iata_code.toLowerCase().includes(query);
      });
    ...
    filteredLocations_departure: function filteredLocations_departure() {
      var _this$form6, _this$form6$routing_i;
      ...
      //     item.iata_code.toLowerCase().includes(query)
      // );
      var query = (((_this$form6 = this.form) === null || _this$form6 === void 0 ? void 0 : (_this$form6$routing_i = _this$form6.routing_information) === null || _this$form6$routing_i === void 0 ? void 0 : _this$form6$routing_i.departure_airport) || '').toLowerCase().trim();
      if (!query) return this.location;
      return this.location.filter(function (item) {
        return item.iata_code.toLowerCase().includes(query);
      });
    ...
    filteredLocations_issuing: function filteredLocations_issuing() {
      var _this$agent_informati, _this$agent_informati2;
      var query = (((_this$agent_informati = this.agent_information) === null || _this$agent_informati === void 0 ? void 0 : (_this$agent_informati2 = _this$agent_informati.routing_information) === null || _this$agent_informati2 === void 0 ? void 0 : _this$agent_informati2.departure_airport) || '').toLowerCase().trim();
      if (!query) return this.location;
      return this.location.filter(function (item) {
        return item.iata_code.toLowerCase().includes(query);
      });
    ...
    filteredLocations_participant: function filteredLocations_participant() {
      var _this$agent_informati3, _this$agent_informati4;
      var query = (_this$agent_informati3 = this.agent_information) === null || _this$agent_informati3 === void 0 ? void 0 : (_this$agent_informati4 = _this$agent_informati3.participate_airport) === null || _this$agent_informati4 === void 0 ? void 0 : _this$agent_informati4.toLowerCase().trim();
      if (!query) return this.location;
      return this.location.filter(function (item) {
        return item.iata_code.toLowerCase().includes(query);
      });
