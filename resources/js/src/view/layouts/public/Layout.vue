        ...
        <div class="container-fluid">
          ...
          <b-collapse id="nav-collapse" is-nav>
            <b-navbar-nav class="ml-auto">
              ...
              <b-nav-item to="/focus-air" class="nav-link-custom text-white"> Web Doc</b-nav-item>
            </b-navbar-nav>
...
export default {
  ...
  data(){
    ...
    blackLogoSrc: "/media/assets/logos/logo-2.png",
    isHovered: false,
    }
  },
  mounted() {
  ...
  methods: {
    toggleLogo(isHovered) {
      this.logoSrc = isHovered ? this.blackLogoSrc : "/media/assets/logos/logo-1.png";
    },
