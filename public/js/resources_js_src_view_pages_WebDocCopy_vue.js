  ...
  methods: {
      ...
      try {
        ...
        result.then(function (response) {
          if (response.data.error) {
            _this2.pdf_error_msg = response.data.error;
            _this2.is_generate_pdf = false;
          } else {
        ...
        this.pdf_error_msg = ((_error$response = error.response) === null || _error$response === void 0 ? void 0 : (_error$response$data = _error$response.data) === null || _error$response$data === void 0 ? void 0 : _error$response$data.message) || 'Failed to generate PDF';
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.mode === 'add') {
        ...
        this.form.put("/user/update-airway-bill/".concat(this.existingData.id)).then(function (response) {
          var _response$data$send_r;
          console.log(response.data.send_response);
          console.log((_response$data$send_r = response.data.send_response) === null || _response$data$send_r === void 0 ? void 0 : _response$data$send_r.status);
          if (response.data && response.data.data.first_box && response.data.data.first_box.original && response.data.data.first_box.original.data && response.data.data.first_box.original.data.id) {
            _this10.existingData = response.data.data.first_box.original.data;
            if (_this10.generatePDFAfterSave && _this10.existingData && _this10.existingData.id) {
              _this10.generateAwbPDF(_this10.generatePDFAfterSave);
    ...
    getAirWayBillForRealod: function getAirWayBillForRealod(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/airway-bill/".concat(id)).then(function (response) {
        ...
        _this13.showAWBSection = false;
        _this13.awbError = ((_error$response2 = error.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 404 ? "Air Waybill not found." : "";
      });
    },
