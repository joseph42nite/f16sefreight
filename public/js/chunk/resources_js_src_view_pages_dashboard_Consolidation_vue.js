...
/* harmony import */ var _view_components_DashboardHistoryModal_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/view/components/DashboardHistoryModal.vue */ "./resources/js/src/view/components/DashboardHistoryModal.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    manifest_send() {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/manifest-send/${this.form.awb_code}${this.form.awb_no}`).then(response => {});
    },
    showModal() {
    ...
    getHousewayBills(status) {
      ...
      this.data_items = [];
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/get-master-awbs-with-housewaybills`).then(response => {
  ...
  components: {
    DashboardHistoryModal: _view_components_DashboardHistoryModal_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
...
var render = function render() {
  ...
  }, [_vm._v("No house waybills found for this master AWB.")])]) : _vm._e()], 1)])])])]);
};
var staticRenderFns = [];
