(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_view_pages_WebDocCopy_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=script&lang=js":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=script&lang=js ***!
  \********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    generateAwbPDF: function generateAwbPDF() {
      ...
      var pdfUrl = "/download-awb-pdf/".concat(itemId);
    ...
    handleAddConsignment: function handleAddConsignment() {
      if (this.isConsignmentAdded) {} else {
    ...
    getLocation: function getLocation() {
      var _this = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-location").then(function (_ref6) {
        var data = _ref6.data;
        _this.location = data;
      });
    },
    fetchShippers: function fetchShippers() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-shippers").then(function (response) {
        ...
        _this2.filteredShippers = _this2.shippers.filter(function (shipper) {
    ...
    fetchConsignee: function fetchConsignee() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-shippers").then(function (response) {
        ...
        _this3.filteredConsignees = _this3.consignees.filter(function (consignee) {
    ...
    fetchAlsoNotify: function fetchAlsoNotify() {
      var _this4 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-shippers").then(function (response) {
        _this4.alsoNotify = response.data;
        _this4.filteredAlsoNotify = _this4.alsoNotify.filter(function (also_notify) {
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.mode === 'add') {
        ...
        this.form.put("/update-airway-bill/".concat(this.existingData.id)).then(function (response) {
    ...
    allAirwayBill: function allAirwayBill() {
      var _this8 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/all-airway-bill').then(function (response) {
        _this8.data_items = response.data;
      })["catch"](function (error) {
    ...
    getAirWayBill: function getAirWayBill(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/airway-bill/".concat(id)).then(function (response) {
        if (response.data && response.data.id == id) {
          _this9.existingData = response.data;
          _this9.showAWBSection = true;
          _this9.awbError = null;
          _this9.openForm('update', _this9.existingData.id);
          if (_this9.existingData && _this9.existingData.consignment_data) {
            _this9.isConsignmentAdded = true;
          }
        } else {
          _this9.showAWBSection = false; // Hide if no data exists
          _this9.awbError = "No data found for this AWB ID.";
        }
      })["catch"](function (error) {
        _this9.existingData = null;
        _this9.showAWBSection = false;
        _this9.awbError = "No data found for this AWB ID.";
        _this9.awbDetails = false;
    ...
    getAirWayBillForRealod: function getAirWayBillForRealod(id) {
      var _this10 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/airway-bill/".concat(id)).then(function (response) {
        var _response$data, _response$data$id;
        var fetchedId = (_response$data = response.data) === null || _response$data === void 0 ? void 0 : (_response$data$id = _response$data.id) === null || _response$data$id === void 0 ? void 0 : _response$data$id.toString();
        ...
        _this10.showAWBSection = false;
        _this10.awbError = ((_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 404 ? "Air Waybill not found." : "";
      });
    },
    ...
    handleEditNavigation: function handleEditNavigation(id) {
      ...
      var targetPath = "/edit-airway-bill/".concat(id);
    ...
    getAgent: function getAgent() {
      var _this11 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/agent-info/").then(function (_ref7) {
        var data = _ref7.data;
        if (Array.isArray(data) && data.length > 0) {
          _this11.agent_information = data[0];
          _this11.iata_cass = {
            iata_agent_code: _this11.agent_information.iata_agent_code || null,
            iata_agent_cass: _this11.agent_information.iata_agent_cass || null
          };
        } else {
          _this11.agent_information = data;
        }
      })["catch"](function (error) {
    ...
    getCountry: function getCountry() {
      var _this12 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/get-country').then(function (_ref8) {
        var data = _ref8.data;
        _this12.countries = Object.keys(data).map(function (key) {
          return {
            value: key,
            text: data[key]
          };
    ...
    getOtherChargesCode: function getOtherChargesCode() {
      var _this13 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/other-charges').then(function (_ref9) {
        var data = _ref9.data;
        _this13.other_charges_code = Object.keys(data).map(function (key) {
          return {
            value: key,
            text: data[key]
          };
    ...
    getOCIData: function getOCIData() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/get-oci-data').then(function (_ref10) {
        ...
        if (data && data.oci_custom_info_identifier) {
          _this14.oci_data.oci_custom_info_identifier = Object.entries(data.oci_custom_info_identifier).map(function (_ref11) {
        ...
        if (data && data.identifiers) {
          _this14.oci_identifiers.identifiers = Object.entries(data.identifiers).map(function (_ref13) {
    ...
    addOrUpdateEntry: function addOrUpdateEntry(evt) {
      ...
      this.consignment_list.post("/get-consignment-error").then(function (response) {
        ...
        if (_this15.edit_entry_index !== null) {
          console.log("Updating entry at index", _this15.edit_entry_index, "with data:", _this15.consignment_list);
          _this15.form.entries[_this15.edit_entry_index] = _objectSpread({}, _this15.consignment_list);
          // this.$set(this.form.entries, this.edit_entry_index, { ...this.consignment_list });
          _this15.edit_entry_index = null;
        } else {
          console.log("Adding new entry:", _this15.consignment_list);
          _this15.form.entries.push(_objectSpread({}, _this15.consignment_list));
        }
        _this15.calculateTotalVolume();
        _this15.calculateTotalAmount();
        _this15.closeModal();
        console.log("Updated form entries:", _this15.form.entries);
    ...
    closeDropdown_participant_airport: function closeDropdown_participant_airport(event) {
    ...
    onAWBInput: lodash_debounce__WEBPACK_IMPORTED_MODULE_4___default()(function () {
      ...
      if (awb_code && awb_no) {
        // this.awbError = null;
        // this.awb_prefix_message = "";
        this.awbId = "".concat(awb_code).concat(awb_no);
    ...
    reloadPageWithContent: function reloadPageWithContent() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/airway-bill/".concat(awbId)).then(function (response) {
        _this19.existingData = response.data;
        if (_this19.existingData) {
          _this19.awbDetails = false;
          _this19.openForm('update', _this19.existingData.id);
          // this.$router.push({ path: `/edit-airway-bill/${awbId}`});
          _this19.location.reload();
          // this.$router.push({ path: `/edit-airway-bill/${awbId}` });
        } else {
          _this19.awbDetails = false;
        }
      })["catch"](function (error) {
        _this19.existingData = null;
  ...
  computed: {
    ...
    filteredLocations_participant: function filteredLocations_participant() {
      var query = this.agent_information.participate_airport.toLowerCase().trim();
      if (!query) return this.location;
      return this.location.filter(function (item) {
        return item.iata_code.toLowerCase().includes(query) || item.destination.toLowerCase().includes(query);
      });
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=template&id=26737c55&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=template&id=26737c55&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\nheader[data-v-26737c55] {\r\n    width: 100%;\r\n    background-color: #2637a8;\n}\n.h-color[data-v-26737c55] {\r\n    color: #2637a8;\n}\n.h_background_color[data-v-26737c55] {\r\n    background-color: #2637a8;\r\n    color: white;\n}\n#nav[data-v-26737c55] {\r\n    display: flex;\r\n    /* align-items: center;\r\n    justify-content: center; */\r\n    width: 100%;\r\n    max-width: 1280px;\r\n    /* margin: 0 auto; */\n}\n#nav>ul[data-v-26737c55] {\r\n    display: flex;\r\n    margin: 0;\r\n    padding: 0;\r\n    list-style-type: none;\n}\n#nav>ul>li[data-v-26737c55]:hover {\r\n    background-color: gray;\n}\n#nav>ul>li>span[data-v-26737c55]:after {\r\n    display: inline-block;\n}\n#nav>ul>li>a[data-v-26737c55] {\r\n    display: block;\r\n    height: auto;\r\n    padding: 3px;\r\n    color: #fff;\r\n    text-decoration: none;\n}\n#nav>ul>li>span[data-v-26737c55] {\r\n    position: relative;\r\n    display: block;\r\n    height: auto;\r\n    padding: 3px;\r\n    color: #fff;\r\n    text-decoration: none;\r\n    cursor: pointer;\n}\nli[data-v-26737c55] {\r\n    border-right: 1px solid white;\n}\n#nav>ul>li>span[data-v-26737c55]:after {\r\n    /* content: '▼'; */\r\n    display: inline-block;\n}\n.dropdown[data-v-26737c55] {\r\n    position: absolute;\r\n    top: 100%;\r\n    left: 0;\r\n    display: none;\r\n    padding: 0;\r\n    list-style-type: none;\r\n    background-color: gray;\n}\n.dropdown li[data-v-26737c55] {\r\n    /* width: 250px; */\r\n    width: 150px;\r\n    border-bottom: 1px solid #fff;\n}\n.dropdown li a[data-v-26737c55] {\r\n    display: block;\r\n    /* padding: 10px; */\r\n    padding-left: 5px;\r\n    color: #fff;\r\n    text-decoration: none;\n}\n.isOpen[data-v-26737c55] {\r\n    display: block;\n}\n.custom-btn[data-v-26737c55] {\r\n    transition: background-color 0.3s;\n}\r\n\r\n/* #show-btn:hover {\r\n  background-color: #007bff;\r\n} */\n.custom-btn[data-v-26737c55]:hover {\r\n    background-color: #007bff !important;\r\n    color: white !important;\n}\n.form-group[data-v-26737c55] {\r\n    margin-bottom: 0px !important;\n}\n.form-control-sm[data-v-26737c55] {\r\n    /* height: 0px !important; */\n}\n.shipper-toggle-label[data-v-26737c55] {\r\n    width: 60px;\r\n    display: inline-block;\r\n    text-align: end;\n}\n.routing-info-label[data-v-26737c55] {\r\n    width :130px;\r\n    display: inline-block;\r\n    text-align: end;\n}\n.form-row[data-v-26737c55] {\r\n    flex-wrap: nowrap !important;\n}\n.col-form-label[data-v-26737c55] {\r\n    padding-top: 0 !important;\r\n    padding-bottom: 0 !important;\r\n    margin-bottom: 0 !important;\r\n    font-size: inherit !important;\r\n    line-height: 1.5 !important;\n}\n.background-color[data-v-26737c55] {\r\n    background-color: grey;\n}\n.hr[data-v-26737c55] {\r\n    border-top: 2px solid #CDCDCD;\n}\n.aselect[data-v-26737c55] {\r\n    position: relative;\r\n    width: 200px;\r\n    /* Adjust the width as needed */\n}\n.selector.box[data-v-26737c55] {\r\n    position: relative;\n}\n.custom-select[data-v-26737c55] {\r\n    appearance: none;\r\n    -webkit-appearance: none;\r\n    -moz-appearance: none;\r\n    background: url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"28\" height=\"34\" viewBox=\"0 0 24 24\"><path fill=\"black\" d=\"M7 10l5 5 5-5z\"/></svg>') no-repeat right center;\r\n    background-color: white;\r\n    /* border: 1px solid #ccc; */\r\n    /* padding: 10px 40px 10px 10px; */\r\n    font-size: 14px;\r\n    /* padding: 2px; */\r\n    cursor: pointer;\r\n    width: 100%;\n}\n.custom-select[data-v-26737c55]:focus {\r\n    outline: none;\r\n    border-color: #5cb3fd;\n}\n.mh-100vh[data-v-26737c55] {\r\n    /* min-height: 100vh; */\n}\n.table[data-v-26737c55] {\r\n    max-width: 400px;\r\n    border: 0;\n}\ntd.editable-cell1[data-v-26737c55] {\r\n    border: 1 solid gray !important;\n}\ntd.editable-cell[data-v-26737c55] {\r\n    border: 0 !important;\n}\nth[data-v-26737c55] {\r\n    border: 0 !important;\n}\n.shipper-form-control[data-v-26737c55], .consignee-form-control[data-v-26737c55] {\r\n    border: 1px solid #A6A6A6;\r\n    width: 300px;\r\n    height: 38px;\n}\n.form-control[data-v-26737c55] {\r\n    border: 1px solid #A6A6A6;\r\n    height: 38px;\n}\n.form-control1[data-v-26737c55] {\r\n    border: 2px solid gray;\r\n    width: 150px;\r\n    height: 25px;\n}\n.add-cons-btn[data-v-26737c55] {\r\n    border: 1px solid #355594 !important;\r\n    border-radius: 30px !important;\r\n    color: #355594 !important;\r\n    background: #fff !important;\n}\n.modal-content[data-v-26737c55] {\r\n    border-radius: 20px !important;\n}\n.modal-header[data-v-26737c55] {\r\n    border-bottom: 0px !important;\n}\n.modal-header > .close[data-v-26737c55] {\r\n    font-size: 2.5rem !important;\n}\n.custom-link[data-v-26737c55] {\r\n    display: block;\r\n    margin-bottom: 0.5rem;\r\n    color: red;\r\n    text-decoration: none;\n}\n.custom-link[data-v-26737c55]:hover {\r\n    color: #2637a8;\r\n    -webkit-text-decoration: underline #2637a8 !important;\r\n            text-decoration: underline #2637a8 !important;\r\n    text-decoration-color: #2637a8;\n}\n.column_b[data-v-26737c55] {\r\n    border: 1px solid #b1b1b1;\n}\n.custom-dropdown[data-v-26737c55] {\r\n  position: relative;\r\n  display: inline-block;\n}\n.dropdown-options[data-v-26737c55] {\r\n    position: absolute;\r\n    border: 1px solid #E4E6EF;\r\n    border-radius: 5px;\r\n    box-shadow: 0px 3px 15px 0px #00000013;\r\n    background-color: #fff;\r\n    border-top: none;\r\n    max-height: 200px;\r\n    overflow-y: auto;\r\n    overflow-x: hidden;\r\n    z-index: 1;\r\n    width: 100%;\n}\n.option[data-v-26737c55] {\r\n    padding: 5px 10px;\r\n    cursor: pointer;\r\n    border-radius: 0px !important;\r\n    padding: 0px 4px !important;\r\n    border: 0px !important;\n}\n.option[data-v-26737c55]:hover {\r\n  background-color: #f0f0f0;\n}\r\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_style_index_0_id_26737c55_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_style_index_0_id_26737c55_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_style_index_1_id_26737c55_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_style_index_1_id_26737c55_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/src/view/pages/WebDocCopy.vue":
/*!****************************************************!*\
  !*** ./resources/js/src/view/pages/WebDocCopy.vue ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _WebDocCopy_vue_vue_type_template_id_26737c55_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./WebDocCopy.vue?vue&type=template&id=26737c55&scoped=true */ "./resources/js/src/view/pages/WebDocCopy.vue?vue&type=template&id=26737c55&scoped=true");
/* harmony import */ var _WebDocCopy_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./WebDocCopy.vue?vue&type=script&lang=js */ "./resources/js/src/view/pages/WebDocCopy.vue?vue&type=script&lang=js");
/* harmony import */ var _WebDocCopy_vue_vue_type_style_index_0_id_26737c55_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css */ "./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css");
/* harmony import */ var _WebDocCopy_vue_vue_type_style_index_1_id_26737c55_lang_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css */ "./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_4__["default"])(
  _WebDocCopy_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _WebDocCopy_vue_vue_type_template_id_26737c55_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _WebDocCopy_vue_vue_type_template_id_26737c55_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "26737c55",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/view/pages/WebDocCopy.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/src/view/pages/WebDocCopy.vue?vue&type=script&lang=js":
/*!****************************************************************************!*\
  !*** ./resources/js/src/view/pages/WebDocCopy.vue?vue&type=script&lang=js ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebDocCopy.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/src/view/pages/WebDocCopy.vue?vue&type=template&id=26737c55&scoped=true":
/*!**********************************************************************************************!*\
  !*** ./resources/js/src/view/pages/WebDocCopy.vue?vue&type=template&id=26737c55&scoped=true ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_template_id_26737c55_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_template_id_26737c55_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_template_id_26737c55_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebDocCopy.vue?vue&type=template&id=26737c55&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=template&id=26737c55&scoped=true");
...
/***/ "./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css":
/*!************************************************************************************************************!*\
  !*** ./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_style_index_0_id_26737c55_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=0&id=26737c55&scoped=true&lang=css");


/***/ }),

/***/ "./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css":
/*!************************************************************************************************!*\
  !*** ./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebDocCopy_vue_vue_type_style_index_1_id_26737c55_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/WebDocCopy.vue?vue&type=style&index=1&id=26737c55&lang=css");
