...
/* harmony import */ var _layout_Header_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../layout/Header.vue */ "./resources/js/src/view/layout/Header.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    isGeneratePdf: function isGeneratePdf(generateButton) {
      ...
      setTimeout(function () {
        if (generateButton == 1 && _this.is_generate_pdf == 1) {
          _this.showSpinner = false;
          _this.is_generate_pdf = 1;
        }
        if (generateButton == 1 && _this.is_generate_pdf == 0) {
          _this.showSpinner = false;
          _this.is_generate_pdf = 1;
        }
      }, 2000);
    ...
    onSubmit: function onSubmit() {
      ...
      var preparedFormData = this.prepareFormDataForSubmission();
      if (this.mode === 'add') {
        // Create a new Form instance with prepared data
        var form = new Form(preparedFormData);
        form.post('/user/create-houseway-bill').then(function (response) {
          ...
          if (response.data && response.data.data.first_box && response.data.data.first_box.original && response.data.data.first_box.original.data && response.data.data.first_box.original.data.id) {
            _this2.existingData = response.data.data.first_box.original.data;
            // console.log('Existing data set:', this.existingData);
            if (_this2.generatePDFAfterSave && _this2.existingData && _this2.existingData.id) {
              _this2.generateHawbPDF();
            }
            _this2.successMessage = '-e-HSWB Saved in database -Pass';
          } else {
          ...
          _this2.main_error_msg = main_error_msg;
          console.error('Add Failed:', error);
        });
      } else if (this.mode === 'update') {
        if (!this.existingData || !this.existingData.id) {
        ...
        var _form = new Form(preparedFormData);
    ...
    getHouseWayBill: function getHouseWayBill(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/houseway-bill/".concat(id)).then(function (response) {
        ...
        _this4.existingData.payment_info = _objectSpread(_objectSpread({}, _this4.defaultPaymentInfo), _this4.existingData.payment_info || {});
        _this4.openForm('update', _this4.existingData.id);
        if (_this4.existingData && _this4.existingData.consignment_data) {
          _this4.isConsignmentAdded = true;
        }
      })["catch"](function (error) {
    ...
    getOtherChargesCode: function getOtherChargesCode() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/user/other-charges').then(function (_ref8) {
        var data = _ref8.data;
        _this7.other_charges_code = Object.keys(data).map(function (key) {
          return {
            value: key,
            text: data[key]
          };
    ...
    fetchShippers: function fetchShippers() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-shippers").then(function (response) {
        _this9.shippers = response.data;
        _this9.filteredShippers = _this9.shippers.filter(function (shipper) {
    ...
    fetchConsignee: function fetchConsignee() {
      var _this10 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-shippers").then(function (response) {
        _this10.consignees = response.data;
        _this10.filteredConsignees = _this10.consignees.filter(function (consignee) {
    ...
    fetchAlsoNotify: function fetchAlsoNotify() {
      var _this11 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-shippers").then(function (response) {
        _this11.alsoNotify = response.data;
        // console.log("fgweuf", response.data);
        _this11.filteredAlsoNotify = _this11.alsoNotify.filter(function (also_notify) {
    ...
    fillShipperDetails: function fillShipperDetails() {
      ...
      if (this.selectedShipper) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-shipper-address?id=".concat(this.selectedShipper)).then(function (response) {
          _this12.form.shipper_address = response.data;
          // console.log('Shipper', response.data);
        })["catch"](function (error) {
    ...
    fillConsigneeDetails: function fillConsigneeDetails() {
      ...
      if (this.selectedConsignee) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-consignee-address?id=".concat(this.selectedConsignee)).then(function (response) {
          _this13.form.consignee_address = response.data;
    ...
    fillAlsoNotifyDetails: function fillAlsoNotifyDetails() {
      ...
      if (this.selectAlsoNotify) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-alsonotify-address?id=".concat(this.selectAlsoNotify)).then(function (response) {
          _this14.form.also_notify_address = response.data;
    ...
    getOCIData: function getOCIData() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/user/get-oci-data').then(function (_ref10) {
        ...
        if (data && data.oci_custom_info_identifier) {
          _this15.oci_data.oci_custom_info_identifier = Object.entries(data.oci_custom_info_identifier).map(function (_ref11) {
        ...
        if (data && data.identifiers) {
          _this15.oci_identifiers.identifiers = Object.entries(data.identifiers).map(function (_ref13) {
  ...
  components: {
    ...
    Header: _layout_Header_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
