...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    autoFillDemo: function autoFillDemo(email) {
      this.user_form.email = email;
      this.user_form.password = "password";
      this.login();
    },
    fetchPorts: function fetchPorts() {
      var _this = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/ports").then(function (res) {
        _this.ports = res.data;
      })["catch"](function (err) {
        return console.error("Failed to load ports:", err);
      });
    },
    login: function login() {
      ...
      this.$store.dispatch(_core_services_store_auth_module__WEBPACK_IMPORTED_MODULE_0__.LOGIN, {
        ...
        _this2.internal_show_login = false;
        _this2.internal_show_otp = false;
      })["catch"](function () {
    ...
    onboard: function onboard() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].post("/register-onboarding", this.signup_form).then(function (res) {
        _this3.$bvToast.toast("Company registered and admin user created successfully!", {
          title: "Success",
          variant: "success",
          solid: true
        });
        ...
        var _this3$signup_form = _this3.signup_form,
          email = _this3$signup_form.email,
          password = _this3$signup_form.password;
        _this3.user_form.email = email;
        _this3.user_form.password = password;
        _this3.authMode = 'login';
        _this3.login();
      })["catch"](function (err) {
        var _err$response;
        console.error("Onboarding failed:", err);
        var errorsObj = (_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.errors;
        if (errorsObj) {
          _this3.signupErrors = Object.values(errorsObj).flat().join(" ");
        } else {
          var _err$response2;
          _this3.signupErrors = ((_err$response2 = err.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.error) || "Registration failed. Check your inputs.";
        }
      })["finally"](function () {
        _this3.signupLoading = false;
      });
    }
  }
});
...
var render = function render() {
  ...
  return _c("div", [_c("b-modal", {
    ...
    staticClass: "modal-left-pane",
    "class": _vm.authMode === "login" ? "login-pane" : "onboard-pane"
  }, [_c("div", {
    ...
    attrs: {
      icon: _vm.authMode === "login" ? "shield-lock" : "building",
      "font-scale": "2.5"
    }
  })], 1), _vm._v(" "), _c("h2", {
    staticClass: "pane-title"
  }, [_vm._v(_vm._s(_vm.authMode === "login" ? "Welcome Back" : "Get Started"))]), _vm._v(" "), _c("p", {
    staticClass: "pane-subtitle"
  }, [_vm._v("\n                        " + _vm._s(_vm.authMode === "login" ? "Securely access your F16s dashboard to manage your freight operations, AWBs, and EDI connectivity." : "Create your company profile and register your admin credentials to start managing global shipments.") + "\n                    ")]), _vm._v(" "), _c("div", {
    ...
    staticClass: "demo-logins-section mb-6 text-center"
  }, [_c("label", {
    staticClass: "small text-muted font-weight-bold d-block mb-3"
  }, [_vm._v("QUICK DEMO ACCESSIBILITY PILLS")]), _vm._v(" "), _c("div", {
    staticClass: "demo-group mb-3 d-flex align-items-center justify-content-center",
    staticStyle: {
      gap: "8px"
    }
  }, [_c("span", {
    staticClass: "badge badge-secondary px-2 py-1",
    staticStyle: {
      "font-size": "10px",
      width: "68px",
      display: "inline-block"
    }
  }, [_vm._v("Core")]), _vm._v(" "), _c("b-button", {
    staticClass: "demo-pill py-0 px-3 font-weight-bold",
    staticStyle: {
      "font-size": "11px",
      "border-radius": "12px",
      height: "24px"
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("core@f16s.com");
      }
    }
  }, [_vm._v("\n                                    Core Operator\n                                ")])], 1), _vm._v(" "), _c("div", {
    staticClass: "demo-group mb-3 d-flex align-items-center justify-content-center",
  ...
  }, [_vm._v("Tactical")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-flex flex-wrap",
    staticStyle: {
      gap: "6px"
    }
  }, [_c("b-button", {
    staticClass: "demo-pill py-0 px-2 font-weight-bold",
    staticStyle: {
      "font-size": "11px",
      "border-radius": "12px",
      height: "24px"
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("tactical.ops@f16s.com");
      }
    }
  }, [_vm._v("Ops")]), _vm._v(" "), _c("b-button", {
    staticClass: "demo-pill py-0 px-2 font-weight-bold",
    staticStyle: {
      "font-size": "11px",
      "border-radius": "12px",
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("tactical.pricing@f16s.com");
      }
    }
  }, [_vm._v("Pricing")]), _vm._v(" "), _c("b-button", {
    staticClass: "demo-pill py-0 px-2 font-weight-bold",
    staticStyle: {
      "font-size": "11px",
      "border-radius": "12px",
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("tactical.sales@f16s.com");
      }
    }
  }, [_vm._v("Sales")]), _vm._v(" "), _c("b-button", {
    staticClass: "demo-pill py-0 px-2 font-weight-bold",
    staticStyle: {
      "font-size": "11px",
      "border-radius": "12px",
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("tactical.boss@f16s.com");
      }
    }
  }, [_vm._v("Boss")])], 1)]), _vm._v(" "), _c("div", {
    staticClass: "demo-group d-flex align-items-center justify-content-center",
    staticStyle: {
      gap: "8px"
    }
  }, [_c("span", {
    staticClass: "badge badge-info px-2 py-1 text-white",
    staticStyle: {
      "font-size": "10px",
      width: "68px",
      display: "inline-block"
    }
  }, [_vm._v("Command")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-flex flex-wrap",
    staticStyle: {
      gap: "6px"
    }
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("command.ops@f16s.com");
      }
    }
  }, [_vm._v("Ops")]), _vm._v(" "), _c("b-button", {
    staticClass: "demo-pill py-0 px-2 font-weight-bold",
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("command.pricing@f16s.com");
      }
    }
  }, [_vm._v("Pricing")]), _vm._v(" "), _c("b-button", {
    staticClass: "demo-pill py-0 px-2 font-weight-bold",
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("command.sales@f16s.com");
      }
    }
  }, [_vm._v("Sales")]), _vm._v(" "), _c("b-button", {
    staticClass: "demo-pill py-0 px-2 font-weight-bold",
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("command.accounts@f16s.com");
      }
    }
  }, [_vm._v("Accounts")]), _vm._v(" "), _c("b-button", {
    staticClass: "demo-pill py-0 px-2 font-weight-bold",
    staticStyle: {
      "font-size": "11px",
      "border-radius": "12px",
    ...
    on: {
      click: function click($event) {
        return _vm.autoFillDemo("command.boss@f16s.com");
      }
    }
  }, [_vm._v("Boss")])], 1)])]), _vm._v(" "), _c("b-row", [_c("b-col", {
    staticClass: "mb-6",
    attrs: {
      md: "12"
    }
    ...
    staticClass: "text-right mt-2 d-flex justify-content-between",
    staticStyle: {
      width: "100%"
    }
  }, [_c("a", {
  ...
  }, [_vm._v("Create an Account")]), _vm._v(" "), _c("router-link", {
    staticClass: "forgot-pwd",
    attrs: {
      to: "/contact-us"
    },
  ...
  }, [_vm._v("Contact Support")])], 1)])], 1) : _c("form", {
    staticClass: "ultra-form",
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.onboard.apply(null, arguments);
      }
    }
  }, [_c("h3", {
    staticClass: "form-section-title mb-6"
  }, [_vm._v("Register Company")]), _vm._v(" "), _vm.signupErrors ? _c("div", {
    staticClass: "error-alert mb-5"
  }, [_c("span", [_vm._v(_vm._s(_vm.signupErrors))])]) : _vm._e(), _vm._v(" "), _c("b-row", [_c("b-col", {
    staticClass: "mb-4",
    attrs: {
      md: "6"
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.signup_form.company_name,
      expression: "signup_form.company_name"
    }],
    staticClass: "floating-input",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.signup_form, "company_name", $event.target.value);
      }
    }
  }), _vm._v(" "), _c("label", {
    staticClass: "floating-label"
    ...
    model: {
      value: _vm.signup_form.tier,
      callback: function callback($$v) {
        _vm.$set(_vm.signup_form, "tier", $$v);
      },
      expression: "signup_form.tier"
    }
  }, [_c("option", {
    attrs: {
      value: "viper_core"
    }
  }, [_vm._v("Viper Core (Free)")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "viper_tactical"
    }
  }, [_vm._v("Viper Tactical")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "viper_command"
    }
  }, [_vm._v("Viper Command")])])], 1)], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-4",
    attrs: {
      md: "6"
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.signup_form.name,
      expression: "signup_form.name"
    }],
    staticClass: "floating-input",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.signup_form, "name", $event.target.value);
      }
    }
  }), _vm._v(" "), _c("label", {
    staticClass: "floating-label"
  }, [_vm._v("Admin Full Name")])])]), _vm._v(" "), _c("b-col", {
    staticClass: "mb-4",
    attrs: {
      md: "6"
    }
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.signup_form, "email", $event.target.value);
      }
    }
  }), _vm._v(" "), _c("label", {
    staticClass: "floating-label"
  }, [_vm._v("Admin Email Address")])])]), _vm._v(" "), _c("b-col", {
    staticClass: "mb-4",
    attrs: {
      md: "6"
    }
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.signup_form, "password", $event.target.value);
      }
    }
  }), _vm._v(" "), _c("label", {
    staticClass: "floating-label"
  }, [_vm._v("Password")])])]), _vm._v(" "), _c("b-col", {
    staticClass: "mb-4",
    attrs: {
      md: "6"
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.signup_form.pima_address,
      expression: "signup_form.pima_address"
    }],
    staticClass: "floating-input",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.signup_form, "pima_address", $event.target.value);
      }
    }
  }), _vm._v(" "), _c("label", {
    staticClass: "floating-label"
  }, [_vm._v("Pima Routing Address")])])]), _vm._v(" "), _c("b-col", {
    staticClass: "mb-4",
    attrs: {
      md: "6"
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.signup_form.origin_airport_code,
      expression: "signup_form.origin_airport_code"
    }],
    staticClass: "floating-input",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.signup_form, "origin_airport_code", $event.target.value);
      }
    }
  }), _vm._v(" "), _c("label", {
    staticClass: "floating-label"
  }, [_vm._v("Origin Airport Code (e.g. DXB)")])])]), _vm._v(" "), _c("b-col", {
    staticClass: "mb-4",
    attrs: {
      md: "6"
    }
    ...
    model: {
      value: _vm.signup_form.default_port_id,
      callback: function callback($$v) {
        _vm.$set(_vm.signup_form, "default_port_id", $$v);
      },
      expression: "signup_form.default_port_id"
    }
  }, [_c("option", {
    domProps: {
      value: null
    }
  }, [_vm._v("-- Select Origin Port --")]), _vm._v(" "), _vm._l(_vm.ports, function (port) {
    return _c("option", {
      key: port.id,
      domProps: {
        value: port.id
      }
    }, [_vm._v("\n                                            " + _vm._s(port.locode) + " - " + _vm._s(port.port_name) + "\n                                        ")]);
  })], 2)], 1)], 1)], 1), _vm._v(" "), _c("div", {
    staticClass: "form-actions mt-4 d-flex flex-column align-items-center w-100"
  }, [_c("button", {
    staticClass: "ultra-submit-btn",
    attrs: {
      type: "submit",
      disabled: _vm.signupLoading
    }
  }, [!_vm.signupLoading ? _c("span", [_vm._v("Onboard Company")]) : _c("b-spinner", {
    attrs: {
      small: "",
      label: "Processing..."
    }
  }), _vm._v(" "), !_vm.signupLoading ? _c("b-icon", {
    staticClass: "btn-icon",
    attrs: {
      icon: "arrow-right"
    }
  ...
  }, [_vm._v("Sign In")])])])], 1)])])])]), _vm._v(" "), _c("b-modal", {
    attrs: {
      id: "otp-modal",
      "hide-header": true,
      "hide-footer": true,
