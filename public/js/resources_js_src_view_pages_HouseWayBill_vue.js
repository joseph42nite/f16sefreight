  ...
  methods: {
    ...
    openForm: function openForm(mode) {
      ...
      if (mode === 'update' && id) {
        ...
        this.form.entries = Array.isArray(this.existingData.consignment_data) ? this.existingData.consignment_data : [this.existingData.consignment_data];
    ...
    getCountry: function getCountry() {
      var _this3 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/get-country').then(function (_ref2) {
        var data = _ref2.data;
    ...
    getAgent: function getAgent() {
      var _this5 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/agent-info/").then(function (_ref4) {
        var data = _ref4.data;
    ...
    addOrUpdateEntry: function addOrUpdateEntry(evt) {
      ...
      this.consignment_list.post("/get-house-consignment-error").then(function (response) {
        if (_this6.edit_entry_index !== null) {
          _this6.form.entries[_this6.edit_entry_index] = _objectSpread({}, _this6.consignment_list);
          // this.$set(this.form.entries, this.edit_entry_index, { ...this.consignment_list });
          _this6.edit_entry_index = null;
        } else {
          _this6.form.entries.push(_objectSpread({}, _this6.consignment_list));
        }
        _this6.calculateTotalVolume();
        _this6.calculateTotalAmount();
        _this6.closeModal();
        //clear consignment_list data
        for (var key in _this6.consignment_list) {
          if (key != 'busy' && key != 'successful' && key != 'errors' && key != 'originalData') {
            if (_typeof(_this6.consignment_list[key]) === 'object') {
              _this6.consignment_list[key] = [];
            } else {
              _this6.consignment_list[key] = '';
            }
          }
    ...
    calculateTotalVolume: function calculateTotalVolume() {
      ...
      var totalVolume = this.form.entries.reduce(function (total, entry) {
        return total + entry.itemss.reduce(function (entryTotal, item) {
          ...
          var selectedUnit = _this7.form.entries.dimention_unit;
          var finalVolume = 0;
          switch (selectedUnit) {
            case 'CMQ':
              // cm³
    ...
    addPcsInfo: function addPcsInfo() {
      ...
      Object.keys(rules).forEach(function (field) {
        ...
        var value = _this8.consignment_list[field];
        if (value) {
          if (rule.type === 'numeric' && (isNaN(value) || value < rule.min || value > rule.max)) {
            _this8.validationErrors.push(rule.message);
