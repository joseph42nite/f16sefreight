...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: (_methods = {
    ...
    return this.filteredAlsoNotify = this.alsoNotify.filter(function (notify) {
      return also_notify.name.toLowerCase().includes(query);
    });
