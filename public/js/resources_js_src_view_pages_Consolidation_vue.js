...
/* harmony import */ var _layout_Header_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../layout/Header.vue */ "./resources/js/src/view/layout/Header.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    generateAwbPDF: function generateAwbPDF() {
      ...
      var itemId = awb_code + awb_no; // Access the awb_no from the form data
    ...
    converXml: function converXml(awb_no) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get("/user/waybill/".concat(awb_no)).then(function (_ref) {
        var data = _ref.data;
      } // console.log(data);
      );
    },
    ...
    getLocation: function getLocation() {
      var _this = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get("/user/get-location").then(function (_ref2) {
        var data = _ref2.data;
        _this.location = data;
      });
    },
    ...
    allHousewayBill: function allHousewayBill() {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get('/user/all-houseway-bill').then(function (response) {
    ...
    searchWayBills: function searchWayBills() {
      ...
      this.form.post('/user/search-house-way-bills', {
        ...
        if (response.data && response.data.length) {
          ...
          _this3.consolidation = [];
          // this.form = [];
          _this3.hasSearchResults = false;
        }
      })["catch"](function (error) {
    ...
    getCountry: function getCountry() {
      var _this5 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get('/user/get-country').then(function (_ref3) {
        var data = _ref3.data;
    ...
    getAgent: function getAgent() {
      var _this6 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get("/user/agent-info/").then(function (_ref4) {
        var data = _ref4.data;
    ...
    getOCIData: function getOCIData() {
      var _this7 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get('/user/get-oci-data').then(function (_ref5) {
        var data = _ref5.data;
        if (data && data.oci_custom_info_identifier) {
          _this7.oci_data.oci_custom_info_identifier = Object.entries(data.oci_custom_info_identifier).map(function (_ref6) {
          ...
          _this7.oci_data.oci_custom_info_identifier = [];
        }
        if (data && data.identifiers) {
          _this7.oci_identifiers.identifiers = Object.entries(data.identifiers).map(function (_ref8) {
    ...
    getHouseWayBill: function getHouseWayBill(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["default"].get("/user/houseway-bill/".concat(id)).then(function (response) {
        _this8.existingData = response.data;
        _this8.openForm('update', _this8.existingData.id);
        if (_this8.existingData && _this8.existingData.consignment_data) {
          _this8.isConsignmentAdded = true;
        }
      })["catch"](function (error) {
        console.error("Failed to fetch data for updating:", error);
      });
  ...
  components: {
    ...
    Header: _layout_Header_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("Draft")]), _vm._v(" "), _c("b-button", {
    directives: [{
      name: "b-modal",
    ...
    staticClass: "mt-5"
  }, [_c("b-col", _vm._l(_vm.data_items, function (item) {
    return _c("div", {
      key: item.id
    }, [_c("div", {
      staticClass: "py-2"
      ...
      on: {
        click: function click($event) {
          return _vm.getHouseWayBill(item.id);
        }
      }
    }, [_c("router-link", {
      attrs: {
        to: "/edit-airway-bill/" + item.id,
        custom: ""
      },
      scopedSlots: _vm._u([{
        key: "default",
        fn: function fn(_ref) {
          ...
          return [_c("p", {
            ...
            staticClass: "custom-link",
            attrs: {
              href: "/download-consolidation-pdf/" + item.awb_code + "/" + item.awb_no,
              target: "_blank"
            }
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function fn(_ref2) {
          ...
          return [_c("p", {
            ...
            staticClass: "custom-link",
            attrs: {
              href: "/download-multiple-consolidation-pdf/" + item.id,
              target: "_blank"
            }
    ...
    }, [_vm._v("Issued at: 15 Jun 14:24 By: jgeorgeblr@gln.com")])])]);
  }), 0)], 1)], 1)])], 1), _vm._v(" "), _c("hr", {
    staticClass: "hr"
  ...
  }, [_vm._v("Create Electronic Consolidation (FHL)")])]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("Nature of Goods")])])])]), _vm._v(" "), _vm._l(_vm.consolidation, function (waybill, index) {
    return _c("div", {
      key: index,
      staticClass: "d-flex",
      staticStyle: {
  ...
  }, [_vm._v("Send")])], 1)])], 1)], 1) : _vm.hasSearchResults ? _c("div", {
    staticClass: "d-flex flex-column align-items-start pt-2 pb-2"
  }, [_c("p", [_vm._v("No house waybill information found. Please use the UI above to add house waybills.")])]) : _vm._e()], 1)], 1)], 1)]);
};
var staticRenderFns = [];
render._withStripped = true;
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Consolidation_vue_vue_type_style_index_1_id_16e4f4e0_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Consolidation.vue?vue&type=style&index=1&id=16e4f4e0&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/Consolidation.vue?vue&type=style&index=1&id=16e4f4e0&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Consolidation_vue_vue_type_style_index_1_id_16e4f4e0_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Consolidation_vue_vue_type_style_index_1_id_16e4f4e0_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Consolidation.vue?vue&type=style&index=1&id=16e4f4e0&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/Consolidation.vue?vue&type=style&index=1&id=16e4f4e0&lang=css");
