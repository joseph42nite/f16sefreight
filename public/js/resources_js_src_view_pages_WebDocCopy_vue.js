...
/* harmony import */ var _view_layout_Header_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/view/layout/Header.vue */ "./resources/js/src/view/layout/Header.vue");
/* harmony import */ var _layout_SideBar_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../layout/SideBar.vue */ "./resources/js/src/view/layout/SideBar.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    handleFileSelect: function handleFileSelect(event) {
      ...
      if (upload_file) {
        ...
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].post('/user/upload-awb-file', formData, {
          ...
          var _response$data, _routing$transit_airp, _routing$transit_airp2, _routing$flights$, _routing$flights$$fli, _routing$flights$2, _routing$flights$2$fl, _routing$flights$3, _routing$flights$4, _routing$flights$4$fl, _routing$flights$5, _routing$flights$5$fl, _routing$flights$6;
          ...
          var all_airport_short_code = [routing.departure_airport, routing.destination_airport, (_routing$transit_airp = routing.transit_airports) === null || _routing$transit_airp === void 0 ? void 0 : _routing$transit_airp[0], (_routing$transit_airp2 = routing.transit_airports) === null || _routing$transit_airp2 === void 0 ? void 0 : _routing$transit_airp2[1]];
          _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].post("/user/get-airport-by-airport-code", {
            ...
            var _response2$data, _response2$, _response2$2, _response2$3, _response2$4;
            ...
            _this.form.routing_information.to = "".concat((_response2$ = response2[2]) === null || _response2$ === void 0 ? void 0 : _response2$['iata_code'], ", ").concat((_response2$2 = response2[2]) === null || _response2$2 === void 0 ? void 0 : _response2$2['destination']);
            _this.form.routing_information.to_2 = "".concat((_response2$3 = response2[3]) === null || _response2$3 === void 0 ? void 0 : _response2$3['iata_code'], ", ").concat((_response2$4 = response2[3]) === null || _response2$4 === void 0 ? void 0 : _response2$4['destination']);
          });
          _this.form.routing_information.by = (_routing$flights$ = routing.flights[0]) === null || _routing$flights$ === void 0 ? void 0 : (_routing$flights$$fli = _routing$flights$.flight_code) === null || _routing$flights$$fli === void 0 ? void 0 : _routing$flights$$fli.slice(0, 2);
          _this.form.routing_information.flight = (_routing$flights$2 = routing.flights[0]) === null || _routing$flights$2 === void 0 ? void 0 : (_routing$flights$2$fl = _routing$flights$2.flight_code) === null || _routing$flights$2$fl === void 0 ? void 0 : _routing$flights$2$fl.slice(2);
          _this.form.routing_information.date = (_routing$flights$3 = routing.flights[0]) === null || _routing$flights$3 === void 0 ? void 0 : _routing$flights$3.date;
          _this.form.routing_information.by_2 = (_routing$flights$4 = routing.flights[1]) === null || _routing$flights$4 === void 0 ? void 0 : (_routing$flights$4$fl = _routing$flights$4.flight_code) === null || _routing$flights$4$fl === void 0 ? void 0 : _routing$flights$4$fl.slice(0, 2);
          _this.form.routing_information.flight_2 = (_routing$flights$5 = routing.flights[1]) === null || _routing$flights$5 === void 0 ? void 0 : (_routing$flights$5$fl = _routing$flights$5.flight_code) === null || _routing$flights$5$fl === void 0 ? void 0 : _routing$flights$5$fl.slice(2);
          _this.form.routing_information.date_2 = (_routing$flights$6 = routing.flights[1]) === null || _routing$flights$6 === void 0 ? void 0 : _routing$flights$6.date;
          ...
          _this.form.shipper_address.ship_name = shipper.company_name;
          _this.form.shipper_address.ship_address = shipper.address;
          _this.form.shipper_address.ship_city = shipper.city;
          _this.form.shipper_address.ship_post_code = shipper.pincode;
          _this.form.shipper_address.ship_state = shipper.state;
          _this.form.shipper_address.ship_country = shipper.country;
          ...
          _this.form.consignee_address.cons_name = consignee.company_name;
          _this.form.consignee_address.cons_address = consignee.address;
          _this.form.consignee_address.cons_city = consignee.city;
          _this.form.consignee_address.cons_post_code = consignee.pincode;
          _this.form.consignee_address.cons_state = consignee.state;
          _this.form.consignee_address.cons_country = consignee.country;
          _this.form.consignee_address.cons_phone = consignee.phone;
          _this.form.consignee_address.cons_fax = consignee.email;
          //end consignee
          //Consignment Information
          var file_consignment_data = response.cargo;
          _this.consignment_list.pieces = file_consignment_data.pieces;
          _this.consignment_list.rate = file_consignment_data.rate;
          _this.consignment_list.hsCodes = file_consignment_data.hs_codes;
          _this.consignment_list.gross_weight = file_consignment_data.gross_weight_kg;
          _this.consignment_list.chargable_weight = file_consignment_data.chargeable_weight_kg;
          _this.consignment_list.description = file_consignment_data.description;
          for (var i = 0; i < file_consignment_data.dimensions.length; i++) {
            var _dimensions_data$, _dimensions_data$2, _dimensions_data$3;
            var dimensions_data = file_consignment_data.dimensions[i].dimensions.split('x');
  ...
  components: {
    ...
    Header: _view_layout_Header_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    SideBar: _layout_SideBar_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
    // PageLoader
  }
});
