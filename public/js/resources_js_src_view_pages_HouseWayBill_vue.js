...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      ...
      this.main_error_msg = '';
      if (this.mode === 'add') {
        this.form.post('/user/create-houseway-bill').then(function (response) {
          console.log('Add Successful:', response);
          if (response.data && response.data.data.first_box && response.data.data.first_box.original && response.data.data.first_box.original.data && response.data.data.first_box.original.data.id) {
            ...
            console.log('Existing data set:', _this2.existingData);
        ...
        this.form.put("/user/update-houseway-bill/".concat(this.existingData.id)).then(function (response) {
          if (response.data && response.data.data.first_box && response.data.data.first_box.original && response.data.data.first_box.original.data && response.data.data.first_box.original.data.id) {
            _this2.existingData = response.data.data.first_box.original.data;
            console.log('Existing data set:', _this2.existingData);
            if (_this2.generatePDFAfterSave && _this2.existingData && _this2.existingData.id) {
    ...
    allHousewayBill: function allHousewayBill(status) {
      var _this3 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/all-houseway-bill/".concat(status)).then(function (response) {
