                                        ...
                                        <b-col cols="auto">
                                            ...
                                            <div v-if="showShipper">
                                                ...
                                                <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                                                    ...
                                                    <b-form-input id="input-horizontal" class="form-control shipper-form-control" v-model="form.shipper_address.ship_account" :class="{ 'is-invalid': form.errors.has('ship_account') }"></b-form-input>
                                        ...
                                        <b-col cols="auto">
                                            ...
                                            <div v-if="showConsignee">
                                                ...
                                                <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                                                    ...
                                                    <b-form-input id="input-horizontal" class="form-control consignee-form-control" v-model="form.consignee_address.cons_account" :class="{ 'is-invalid': form.errors.has('cons_account') }"></b-form-input>
                                        ...
                                        <b-row class="mt-5">
                                            <b-col cols="5">
                                                <b-form-group id="fieldset-horizontal" label-cols-lg="auto"
                                                    ...
                                                    <div class="custom-dropdown  align-items-center" ref="dropdownContainer_departure" @click="toggleDropdown_departure">
                                                ...
                                                <b-form-group id="fieldset-horizontal" label-cols-lg="auto"
                                                    ...
                                                    <template #label>
                                                        ...
                                                        <div class="custom-dropdown align-items-center" ref="dropdownContainer_destination" @click="toggleDropdown_destination">
                                                            <input style="width:230px" type="text" v-model="form.routing_information.destination_airport" placeholder="Search destination" id="destination" class="form-control" 
                                                    ...
                                                    <has-error :form="form" field="routing_information.destination_airport"></has-error>
                                                </b-form-group>
                                            </b-col>
                                            <b-col cols="7">
                                                <!-- <div class="d-flex flex-column align-items-center"> -->
                                                    <div class="container">
                                                        <table class="">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>Routing:<span style="color: red;">*</span></td>
                                                                    <td class="editable-cell">
                                                                        <!-- <b-form-group id="fieldset-horizontal" label-cols-lg="auto" label-for="input-form-airport" class="align-items-center"> -->
                                                                                <div class="custom-dropdown align-items-center" ref="dropdownContainer_from" @click="toggleDropdown_from">
                                                                                    <input type="text" v-model="form.routing_information.from" placeholder="Search destination" id="from_id" style="width:170px !important;" class="form-control" 
                                                                    ...
                                                                    <td class="editable-cell">
                                                                        <!-- <b-form-group id="fieldset-horizontal" label-cols-lg="auto" label-for="input-to" class="align-items-center"> -->
                                                                                <div class="custom-dropdown align-items-center" ref="dropdownContainer_to" @click="toggleDropdown_to">
                                                                                    <input type="text" v-model="form.routing_information.to" placeholder="Search destination" id="to_id" style="width:170px !important;" class="form-control" 
                                                                    ...
                                                                    <td class="editable-cell">
                                                                        <input type="text" class="form-control"
                                                                            style=" width: 60px;" v-model="form.routing_information.flight"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="editable-cell">
                                                                        ...
                                                                        <div class="custom-dropdown" ref="dropdownContainer_to2" @click="toggleDropdown_to2">
                                                                            <input type="text" v-model="form.routing_information.to_2" placeholder="Search destination" id="to2_id" style="width:170px;"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="editable-cell">
                                                                        ...
                                                                        <div class="custom-dropdown" ref="dropdownContainer_to3" @click="toggleDropdown_to3">
                                                                            <input type="text" v-model="form.routing_information.to_3" placeholder="Search destination" id="to3_id" style="width:170px;" class="form-control" 
                                    ...
                                    <b-row>
                                        ...
                                        <b-col cols="6">
                                            <div class="d-flex justify-content-end align-items-center mr-16">
                                                <p class="mb-0 ml-4 mr-4 h-color" style="border-bottom: 1px solid #2637a8;">Get Rates</p>
                                            ...
                                            <div class="d-flex align-items-center mr-32 mt-4">
                                                <b-form-group id="fieldset-horizontal" class="">
                                                    <div class="d-flex align-items-center mb-2">
                                                        ...
                                                        <b-form-select class="form-control" v-model="form.entries.dimention_unit" style="width:60px;background-position-x: right;">
                                                            <option value="CMQ">cm³</option> <!-- CC Cubic centimetre-->
                                                            <option value="MTQ">m³</option> <!-- MC  Cubic Metre-->  
                                                            <option value="FTQ">ft³</option> <!-- CF  Cubic Foot--> 
                                                            <option value="INQ">in³</option> <!-- CI  Cubic inch--> 
