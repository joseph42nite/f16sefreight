            ...
            <template>
                <b-form @submit.prevent="onSubmit">
                    <div class="container">
                        ...
                        <div class="d-flex mt-5">
                            <div>
                                <b-form-group id="fieldset-horizontal" content-cols-sm
                                    ...
                                    <template #label>
                                        <label>HWB No: <span class="text-danger">*</span></label>
                                    </template>
                                    <b-form-input id="input-horizontal" class="form-control-sm" style="width: 40px;border-radius: 0px;"
                                        v-model="form.first_box.master_code"
                                        :class="{ 'is-invalid': form.errors.has('master_code') }"></b-form-input>
                                    <has-error :form="form" field="master_code"></has-error>
                                </b-form-group>
                            </div>
                            -
                            <div>
                                <b-form-group id="fieldset-horizontal" content-cols-sm
                                    ...
                                    <b-form-input id="input-horizontal" class="form-control-sm" style="width: 120px"
                                        v-model="form.first_box.master_no"
                                        :class="{ 'is-invalid': form.errors.has('master_no') }"></b-form-input>
                                    <has-error :form="form" field="master_no"></has-error>
                                </b-form-group>
                            </div> 
                        </div>
                            ...
                            <div class="py-md-4">
                                    ...
                                    <b-tab title="House Waybill Details" class="bg-white" style="border:1px solid #000 !important;">
                                        <b-row class="hwb-details mt-5 mb-1">
                                            <b-col cols="auto">
                                                ...
                                                <b-form-input id="input-hwb" class="form-control-sm" style="width:250px;" v-model="iata_cass.hwb_no"></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                            <b-col cols="auto">
                                                <!-- Weight input -->
                                                ...
                                                <b-form-input id="input-destination" class="form-control-sm" v-model="iata_cass.destination"></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                            <b-col cols="auto" style="padding-right:0px !important;">
                                                ...
                                                <b-form-input id="input-destination" class="form-control-sm" style="width:70px;padding-right:0px !important;" v-model="iata_cass.destination"></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                        </b-row>
                                            ...
                                            <b-col cols="auto">
                                                <b-form-group id="fieldset-horizontal"
                                                    ...
                                                    style="width:180px;"
                                                        ...
                                                        <option value=""> Total Consignment</option>
                                                        <option value="CC">Divided Consignment</option>
                                                        <option value="CC">Multi Shipments</option>
                                                        <option value="CC">Part Consignment</option>
                                                        <option value="CC">Split Consignment</option>
                                                    </b-form-select>
                                                </b-form-group>
                                            </b-col>
                                        </b-row>
                                        <b-row class="hwb-details mb-1">
                                            <b-col cols="auto">
                                                ...
                                                style="padding-right:0px !important;">
                                                    ...
                                                    <b-form-input id="input-hwb" class="form-control-sm" style="width: 50px;" v-model="iata_cass.hwb_no"></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                            <b-col cols="auto" style="padding-left:0px;">
                                                ...
                                                <b-form-input id="input-origin" class="form-control-sm" style="width: 50px;" v-model="iata_cass.origin"></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                            <b-col cols="auto">
                                                <!-- Weight input -->
                                        ...
                                        <b-row class="hwb-details mb-4">
                                            <b-col cols="auto">
                                                ...
                                                class="form-control-sm custom-label-styling">
                                                    ...
                                                    <b-form-input id="input-hwb" class="form-control-sm" style="width:300px;" v-model="iata_cass.hwb_no"></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                        </b-row>
                                        <b-row class="hwb-details mb-4">
                                            <b-col cols="auto" style="padding-right:0px!important;">
                                                ...
                                                <b-form-group id="fieldset-horizontal"
                                                    ...
                                                    <b-form-select class="form-control-sm"
                                                        v-model="form.payment_info.type_of_payment" style="width:500px;">
                                            ...
                                            <b-col cols="auto" style="padding-left: 0px;padding-right: 0px;">
                                                ...
                                                <b-form-input id="input-origin" class="form-control-sm" v-model="iata_cass.origin"></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                            <b-col cols="auto" style="padding-left: 0px;">
                                                <!-- Add button -->
                                        ...
                                        <b-row class="mb-4">
                                            <div class="d-flex text-align-center flex-column" style="margin-left:213px;">
                                                <table style="width:630px;">
                                                    ...
                                                    <tr>
                                                        <td class="" style="border: 1px solid #c2c0c0;padding: 4px 20px;">
                                                            057-51929872
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <b-col class="ml-4">
                                                ...
                                                <b-row class="mt-1">
                                                    ...
                                                    <b-col cols="auto" style="padding-left:2px;">
                                                        ...
                                                        style="padding-left:0px !important;">
                                                            <b-form-select class="form-control-sm"
                                                            style="width:280px;border-radius: 0px;"
                                                                v-model="form.payment_info.type_of_payment">
                                                                <option value="">Select a code</option>
                                                            </b-form-select>
                                                        </b-form-group>
                                                ...
                                                <b-row>
                                                    <b-col cols="auto" >
                                                        <b-form-group id="fieldset-horizontal"
                                                            ...
                                                            <b-form-input id="input-origin" class="form-control-sm" v-model="iata_cass.origin" 
                                                            style="border-radius: 0px;width:350px;"></b-form-input>
                                                        </b-form-group>
                                                    </b-col>
                                                    <b-col cols="auto" style="padding-left: 0px;">
                                                    <!-- Add button -->
                                                    <b-button class="" style="border-radius: 2px;border:1px solid #000;padding:4px 20px">Add</b-button>
                                                </b-col>
                                                </b-row>
                                                <b-row>
                                ...
                                <div class="pt-6">
                                    <div class="d-flex justify-content-end">
                                        <b-button class="" @click="" style="padding:4px 20px;border:1px solid #000;border-radius:0px;">Add detail row</b-button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex" style="background-color: #E6EBFF;">
