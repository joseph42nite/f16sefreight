...
/***/ "./resources/js/src/core/config/helpTargets.js":
/*!*****************************************************!*\
  !*** ./resources/js/src/core/config/helpTargets.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "HELP_TARGETS": () => (/* binding */ HELP_TARGETS),
/* harmony export */   "HELP_TARGET_NAMES": () => (/* binding */ HELP_TARGET_NAMES)
/* harmony export */ });
/**
...
// Inbox (/inbox)
{
  name: "inbox-folders",
  page: "/inbox",
  label: "Folder tabs (All, Enquiries, Airline…)"
}, {
  name: "thread-classification",
  page: "/inbox",
  label: "Classification dropdown on a conversation"
}, {
  name: "claim-thread",
  page: "/inbox",
  label: "Claim button"
  ...
  page: "/inbox",
  label: "Attachment chips under an email"
}, {
  name: "reply",
  page: "/inbox",
  label: "Reply button"
  ...
  name: "compose-editor",
  page: "/inbox",
  label: "Message box with formatting toolbar"
}, {
  name: "add-signature",
  page: "/inbox",
  label: "Add signature switch"
}, {
  name: "attach-files",
  page: "/inbox",
...
// Extraction panel (inside the inbox workspace)
{
  name: "extract-into",
  page: "/inbox",
  label: "Extract into: Master / House AWB and number"
}, {
  name: "choose-files",
  page: "/inbox",
  label: "Documents drop zone / Choose files"
}, {
  name: "extract-document",
  page: "/inbox",
  label: "Extract button on a document"
}, {
  name: "take-from-it",
  page: "/inbox",
  label: "Take from it dropdown"
}, {
  name: "paste-text",
  page: "/inbox",
  label: "Paste anything specific box"
}, {
  name: "what-will-be-used",
  page: "/inbox",
  label: "What will be used table"
}, {
  name: "save-draft",
  page: "/inbox",
