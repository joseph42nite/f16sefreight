...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    calculateTotalVolume: function calculateTotalVolume() {
      var totalVolume = this.form.entries.reduce(function (total, entry) {
        return total + entry.itemss.reduce(function (entryTotal, item) {
          var volumePerPiece = item.length * item.width * item.height / 1e6;
    ...
    calculateTotalAmount: function calculateTotalAmount() {
      var chargeableWeight = parseFloat(this.form.entries.reduce(function (total, entry) {
        return total + (parseFloat(entry.chargable_weight) || 0);
      }, 0)) || 0;
      var rate = parseFloat(this.form.entries.reduce(function (total, entry) {
  ...
  watch: {
    ...
    'form.entries.itemss': function formEntriesItemss() {
      this.calculateTotalVolume();
    },
    'form.charges': {
