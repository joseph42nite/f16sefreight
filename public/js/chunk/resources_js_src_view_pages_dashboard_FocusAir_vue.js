...
/* harmony import */ var _core_config_iata__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/core/config/iata */ "./resources/js/src/core/config/iata.js");
...
/* harmony import */ var _view_layouts_public_SideBar_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/view/layouts/public/SideBar.vue */ "./resources/js/src/view/layouts/public/SideBar.vue");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.esm.js");
/* harmony import */ var _view_components_OcrUploadModal_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/view/components/OcrUploadModal.vue */ "./resources/js/src/view/components/OcrUploadModal.vue");
/* harmony import */ var _view_components_DashboardHistoryModal_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @/view/components/DashboardHistoryModal.vue */ "./resources/js/src/view/components/DashboardHistoryModal.vue");
/* harmony import */ var _core_mixins_airWayBillMixin__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @/core/mixins/airWayBillMixin */ "./resources/js/src/core/mixins/airWayBillMixin.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "FocusAir",
  mixins: [_core_mixins_airWayBillMixin__WEBPACK_IMPORTED_MODULE_11__["default"]],
  data() {
    return {
      form: new Form({
        awb_email: '',
  ...
  methods: {
    ...
    processExtractedData(response) {
      ...
      if (departure && destination) {
        ...
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].post(`/user/get-airport-by-airport-code`, {
      ...
      if (piece_weight) {
        ...
        let rate_class = piece_weight.rate_class ? piece_weight.rate_class.length > 2 ? piece_weight.rate_class.slice(2) : piece_weight.rate_class : '';
    ...
    iataViolations() {
      ...
      return (0,_core_config_iata__WEBPACK_IMPORTED_MODULE_5__.checkAll)(values).map(v => `${v.field.replace(/_/g, ' ')} — ${v.message}`);
    },
    ...
    converXml(awb_no) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/waybill/${awb_no}`).then(({
        data
      }) => {
        // console.log(data);
      });
    ...
    fetchAllAddressBook() {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get('/user/get-shippers').then(response => {
    ...
    fillShipperDetails() {
      if (this.selectedShipper) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/get-shipper-address?id=${this.selectedShipper}`).then(response => {
    ...
    fillConsigneeDetails() {
      if (this.selectedConsignee) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/get-consignee-address?id=${this.selectedConsignee}`).then(response => {
    ...
    fillAlsoNotifyDetails() {
      if (this.selectAlsoNotify) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/get-alsonotify-address?id=${this.selectAlsoNotify}`).then(response => {
    ...
    onSubmit() {
      ...
      if (this.mode === 'add') {
        ...
        this.form.post(`/user/create-focusair`).then(response => {
          $('.submit-button').css({
            'pointer-events': 'auto',
            'opacity': '1'
          });
        ...
        // Object.assign(this.form, preparedFormData);
        this.from = _objectSpread({}, this.form);
        this.form.put(`/user/update-airway-bill/${this.existingData.id}`).then(response => {
          $('.submit-button').css({
            'pointer-events': 'auto',
            'opacity': '1'
          });
    ...
    getAirwayBills(status) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/get-airway-bills/${status}`).then(response => {
    ...
    getAirWayBill(id) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/airway-bill/${id}`).then(response => {
    ...
    getAirWayBillForRealod(id) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/airway-bill/${id}`).then(response => {
        ...
        this.showAWBSection = false;
        this.awbError = error.response?.status === 404 ? "Air Waybill not found." : "";
      });
    },
    ...
    getAgent(company_id, branch_id) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/agent-info`).then(({
        data
      }) => {
    ...
    getCountry() {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get('/user/get-country').then(({
        data
      }) => {
    ...
    getOtherChargesCode() {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get('/user/other-charges').then(({
        data
      }) => {
    ...
    getOCIData() {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get('/user/get-oci-data').then(({
        data
      }) => {
    ...
    onAWBInput: lodash_debounce__WEBPACK_IMPORTED_MODULE_7___default()(function () {
      const {
        awb_code,
        awb_no
      } = this.form.first_box;
      if (awb_code && awb_code.length === 3) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/get-awbcode-prefix/${awb_code}`).then(response => {
          if (response.data) {
            const {
              name,
              code
    ...
    confirmReload() {
      const confirmed = window.confirm(`Are you sure you want to reload the content for AWB: ${this.awbId}?`);
      if (confirmed) {
        this.awbDetails = false;
        this.showAWBSection = false;
    ...
    reloadPageWithContent() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/airway-bill/${awbId}`).then(response => {
        this.existingData = response.data;
  ...
  components: {
    DashboardHistoryModal: _view_components_DashboardHistoryModal_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    OcrUploadModal: _view_components_OcrUploadModal_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    Datepicker: vuejs_datepicker__WEBPACK_IMPORTED_MODULE_1__["default"],
    DatePicker: vue2_datepicker__WEBPACK_IMPORTED_MODULE_2__["default"],
    SideBar: _view_layouts_public_SideBar_vue__WEBPACK_IMPORTED_MODULE_8__["default"]
    // PageLoader
  }
});
