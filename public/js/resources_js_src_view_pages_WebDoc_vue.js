  ...
  methods: {
    ...
    allAirwayBill: function allAirwayBill() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/all-airway-bill').then(function (response) {
        _this6.data_items = response.data;
      })["catch"](function (error) {
    ...
    getAirWayBill: function getAirWayBill(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/airway-bill/".concat(id)).then(function (response) {
        _this7.existingData = response.data;
        _this7.openForm('update', _this7.existingData.id);
      })["catch"](function (error) {
    ...
    getCountry: function getCountry() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/get-country').then(function (_ref4) {
        var data = _ref4.data;
        _this9.countries = Object.keys(data).map(function (key) {
          return {
            value: key,
            text: data[key]
          };
    ...
    addOrUpdateEntry: function addOrUpdateEntry(evt) {
      ...
      this.consignment_list.post("/get-consignment-error").then(function (response) {
        if (_this10.edit_entry_index !== null) {
          _this10.form.entries[_this10.edit_entry_index] = _objectSpread({}, _this10.consignment_list);
          // this.$set(this.form.entries, this.edit_entry_index, { ...this.consignment_list });
          _this10.edit_entry_index = null;
        } else {
          _this10.form.entries.push(_objectSpread({}, _this10.consignment_list));
        }
        _this10.calculateTotalVolume();
        _this10.calculateTotalAmount();
        _this10.closeModal();
        //clear consignment_list data
        for (var key in _this10.consignment_list) {
          if (key != 'busy' && key != 'successful' && key != 'errors' && key != 'originalData') {
            if (_typeof(_this10.consignment_list[key]) === 'object') {
              _this10.consignment_list[key] = [];
            } else {
              _this10.consignment_list[key] = '';
            }
          }
    ...
    calculateTotalVolume: function calculateTotalVolume() {
      ...
      var totalVolume = this.form.entries.reduce(function (total, entry) {
        return total + entry.itemss.reduce(function (entryTotal, item) {
          ...
          var selectedUnit = _this11.form.entries.dimention_unit;
          var finalVolume = 0;
          switch (selectedUnit) {
            case 'CMQ':
              // cm³
    ...
    addPcsInfo: function addPcsInfo() {
      ...
      Object.keys(rules).forEach(function (field) {
        ...
        var value = _this12.consignment_list[field];
        if (value) {
          if (rule.type === 'numeric' && (isNaN(value) || value < rule.min || value > rule.max)) {
            _this12.validationErrors.push(rule.message);
