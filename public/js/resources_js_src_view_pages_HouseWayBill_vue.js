...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    generateHawbPDF: function generateHawbPDF() {
      ...
      var itemId = this.$route.params.id; // Get the ID from the URL
      var pdfUrl = "/download-hawb-pdf/".concat(itemId); // Construct the URL for the PDF
    ...
    converXml: function converXml(awb_no) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/waybill/".concat(awb_no)).then(function (_ref5) {
        var data = _ref5.data;
        console.log(data);
      });
    },
    ...
    onSubmit: function onSubmit() {
      if (this.mode === 'add') {
        this.form.post('/create-houseway-bill').then(function (response) {
    ...
    allHousewayBill: function allHousewayBill() {
      var _this = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/all-houseway-bill').then(function (response) {
        _this.data_items = response.data;
      })["catch"](function (error) {
    ...
    getHouseWayBill: function getHouseWayBill(id) {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/houseway-bill/".concat(id)).then(function (response) {
        _this2.existingData = response.data;
        _this2.openForm('update', _this2.existingData.id);
        if (_this2.existingData && _this2.existingData.consignment_data) {
          _this2.isConsignmentAdded = true;
        }
      })["catch"](function (error) {
    ...
    getCountry: function getCountry() {
      var _this3 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/get-country').then(function (_ref6) {
        var data = _ref6.data;
    ...
    getLocation: function getLocation() {
      var _this4 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-location").then(function (_ref7) {
        var data = _ref7.data;
    ...
    getOtherChargesCode: function getOtherChargesCode() {
      var _this5 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/other-charges').then(function (_ref8) {
        var data = _ref8.data;
        _this5.other_charges_code = Object.keys(data).map(function (key) {
          return {
            value: key,
            text: data[key]
          };
    ...
    getAgent: function getAgent() {
      var _this6 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/agent-info/").then(function (_ref9) {
        var data = _ref9.data;
    ...
    fetchShippers: function fetchShippers() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-shippers").then(function (response) {
        _this7.shippers = response.data;
        _this7.filteredShippers = _this7.shippers.filter(function (shipper) {
    ...
    fetchConsignee: function fetchConsignee() {
      var _this8 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-shippers").then(function (response) {
        _this8.consignees = response.data;
        _this8.filteredConsignees = _this8.consignees.filter(function (consignee) {
    ...
    fetchAlsoNotify: function fetchAlsoNotify() {
      var _this9 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-shippers").then(function (response) {
        _this9.alsoNotify = response.data;
        console.log("fgweuf", response.data);
        _this9.filteredAlsoNotify = _this9.alsoNotify.filter(function (also_notify) {
    ...
    fillShipperDetails: function fillShipperDetails() {
      ...
      if (this.selectedShipper) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-shipper-address?id=".concat(this.selectedShipper)).then(function (response) {
          _this10.form.shipper_address = response.data;
          // console.log('Shipper', response.data);
        })["catch"](function (error) {
    ...
    fillConsigneeDetails: function fillConsigneeDetails() {
      ...
      if (this.selectedConsignee) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-consignee-address?id=".concat(this.selectedConsignee)).then(function (response) {
          _this11.form.consignee_address = response.data;
    ...
    fillAlsoNotifyDetails: function fillAlsoNotifyDetails() {
      ...
      if (this.selectAlsoNotify) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-alsonotify-address?id=".concat(this.selectAlsoNotify)).then(function (response) {
          _this12.form.also_notify_address = response.data;
    ...
    getOCIData: function getOCIData() {
      var _this13 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/get-oci-data').then(function (_ref10) {
        var data = _ref10.data;
        if (data && data.oci_custom_info_identifier) {
          _this13.oci_data.oci_custom_info_identifier = Object.entries(data.oci_custom_info_identifier).map(function (_ref11) {
        ...
        if (data && data.identifiers) {
          _this13.oci_identifiers.identifiers = Object.entries(data.identifiers).map(function (_ref13) {
    ...
    addOrUpdateEntry: function addOrUpdateEntry(evt) {
      ...
      this.consignment_list.post("/get-house-consignment-error").then(function (response) {
        if (_this14.edit_entry_index !== null) {
          _this14.form.entries[_this14.edit_entry_index] = _objectSpread({}, _this14.consignment_list);
          // this.$set(this.form.entries, this.edit_entry_index, { ...this.consignment_list });
          _this14.edit_entry_index = null;
        } else {
          _this14.form.entries.push(_objectSpread({}, _this14.consignment_list));
        }
        _this14.calculateTotalVolume();
        _this14.calculateTotalAmount();
        _this14.isConsignmentAdded = _this14.form.entries.length > 0;
        _this14.closeModal();
        //clear consignment_list data
        for (var key in _this14.consignment_list) {
          if (key != 'busy' && key != 'successful' && key != 'errors' && key != 'originalData') {
            if (_typeof(_this14.consignment_list[key]) === 'object') {
              _this14.consignment_list[key] = [];
            } else {
              _this14.consignment_list[key] = '';
            }
          }
    ...
    calculateTotalVolume: function calculateTotalVolume() {
      ...
      var totalVolume = this.form.entries.reduce(function (total, entry) {
        return total + entry.itemss.reduce(function (entryTotal, item) {
          ...
          var selectedUnit = _this15.form.totals.dimention_unit;
          var finalVolume = 0;
          switch (selectedUnit) {
            case 'CMQ':
              // cm³
    ...
    addPcsInfo: function addPcsInfo() {
      ...
      Object.keys(rules).forEach(function (field) {
        ...
        var value = _this16.consignment_list[field];
        if (value) {
          if (rule.type === 'numeric' && (isNaN(value) || value < rule.min || value > rule.max)) {
            _this16.validationErrors.push(rule.message);
    ...
    onAWBInput: lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()(function () {
      ...
      if (awb_code && awb_code.length === 3) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/get-awbcode-prefix/".concat(awb_code)).then(function (response) {
          if (response.data) {
            var _response$data = response.data,
              name = _response$data.name,
              code = _response$data.code;
            _this17.awb_prefix_message = "Message will be sent to ".concat(name, " (").concat(code, ")");
          } else {
            _this17.awb_prefix_message = "No agreement found for: ".concat(awb_code, " You will not be able to send the message to this carrier - only generate a PDF.");
          }
        })["catch"](function (error) {
