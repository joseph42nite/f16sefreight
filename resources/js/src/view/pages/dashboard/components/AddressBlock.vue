<template>
    <b-col cols="auto">
        ...
        <div v-if="show">
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" :label-for="name2Id" class="pb-2 align-items-center">
                <template #label>
                    <div class="shipper-toggle-label">
                        <span>&nbsp;</span>
                    </div>
                </template>
                <b-form-input :id="name2Id" class="form-control" :class="[controlClass, name2ExtraClass, { 'is-invalid': form.errors.has(prefix + '_name_2') }]" v-model="address[prefix + '_name_2']" autocomplete="off"></b-form-input>
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-input id="input-horizontal" class="form-control" :class="[controlClass, { 'is-invalid': form.errors.has(prefix + '_account') }]" v-model="address[prefix + '_account']"></b-form-input>
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-input id="input-horizontal" class="form-control" :class="[controlClass, { 'is-invalid': form.errors.has(prefix + '_address') }]" v-model="address[prefix + '_address']" @keydown="$emit('limit', $event, addressKey + '.' + prefix + '_address', 40)"></b-form-input>
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-input id="input-horizontal" class="form-control" :class="[controlClass, { 'is-invalid': form.errors.has(prefix + '_address_line_2') }]" v-model="address[prefix + '_address_line_2']" @keydown="$emit('limit', $event, addressKey + '.' + prefix + '_address_line_2', 35)"></b-form-input>
                ...
                <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="align-items-center">
                    ...
                    <div class="d-flex align-items-center pb-2">
                        <b-form-input id="input-horizontal" class="form-control" :class="[cityControlClass, { 'is-invalid': form.errors.has(prefix + '_city') }]" style="width: 240px" v-model="address[prefix + '_city']"></b-form-input>
                        <b-form-input id="input-horizontal" class="ml-3 form-control" :class="[cityControlClass, { 'is-invalid': form.errors.has('ship_airport_code') }]" style="width: 50px" v-model="address.ship_airport_code"></b-form-input>
                    </div>
                    <div>
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-input id="input-horizontal" class="form-control" :class="[controlClass, { 'is-invalid': form.errors.has(prefix + '_post_code') }]" style="width:200px;" v-model="address[prefix + '_post_code']"></b-form-input>
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-input id="input-horizontal" class="form-control" :class="[controlClass, { 'is-invalid': form.errors.has(prefix + '_state') }]" style="width:200px;" v-model="address[prefix + '_state']"></b-form-input>
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-select class="form-control" :class="[controlClass, { 'is-invalid': form.errors.has(prefix + '_country') }]" v-model="address[prefix + '_country']">
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-input id="input-horizontal" class="form-control" :class="[controlClass, { 'is-invalid': form.errors.has(prefix + '_phone') }]" style="width:200px;" v-model="address[prefix + '_phone']"></b-form-input>
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-input id="input-horizontal" class="form-control" :class="[controlClass, { 'is-invalid': form.errors.has(prefix + '_fax') }]" style="width:200px;" v-model="address[prefix + '_fax']"></b-form-input>
            ...
            <b-form-group id="fieldset-horizontal" label-cols-lg="auto" content-cols-sm content-cols-lg="auto" label-for="input-horizontal" class="pb-2 align-items-center">
                ...
                <b-form-input id="input-horizontal" class="form-control" :class="controlClass" style="width:200px;" v-model="address[prefix + '_telex']"></b-form-input>
            </b-form-group>
            <b-form-checkbox size="sm" class="" style="margin-left: 90px;" :checked="saveChecked" @change="$emit('update:saveChecked', $event)"> Save new address to address book</b-form-checkbox>
        </div>
    </b-col>
</template>
...
export default {
    ...
    props: {
        ...
        searchId: { type: String, required: true },          // input id for the search box
        searchPlaceholder: { type: String, required: true }, // "Search shipper" / "Search consignee"
        name2Id: { type: String, required: true },           // id for the name_2 input
        name2ExtraClass: { type: String, default: "" },      // "ship_name_2" for shipper, "" for consignee
        countryPlaceholder: { type: String, default: "Please select one" },
        form: { type: Object, required: true },              // the vform (errors + validation)
