  ...
  methods: {
    ...
    handleSaveAndGeneratePDF: function handleSaveAndGeneratePDF(pdf_generate_type) {
      ...
      result.then(function (response) {
        if (response.data && response.data.data && response.data.data.id) {} else {
    ...
    getLocation: function getLocation() {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-location").then(function (_ref5) {
        var data = _ref5.data;
        _this2.location = data;
      });
    },
    fetchShippers: function fetchShippers() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-shippers").then(function (response) {
        _this3.shippers = response.data;
        _this3.filteredShippers = _this3.shippers.filter(function (shipper) {
    ...
    fetchConsignee: function fetchConsignee() {
      var _this4 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-shippers").then(function (response) {
        _this4.consignees = response.data;
        _this4.filteredConsignees = _this4.consignees.filter(function (consignee) {
    ...
    fetchAlsoNotify: function fetchAlsoNotify() {
      var _this5 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-shippers").then(function (response) {
        _this5.alsoNotify = response.data;
        _this5.filteredAlsoNotify = _this5.alsoNotify.filter(function (also_notify) {
    ...
    fillShipperDetails: function fillShipperDetails() {
      ...
      if (this.selectedShipper) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-shipper-address?id=".concat(this.selectedShipper)).then(function (response) {
          _this6.form.shipper_address = response.data;
          // console.log('Shipper', response.data);
        })["catch"](function (error) {
    ...
    fillConsigneeDetails: function fillConsigneeDetails() {
      ...
      if (this.selectedConsignee) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-consignee-address?id=".concat(this.selectedConsignee)).then(function (response) {
          _this7.form.consignee_address = response.data;
    ...
    fillAlsoNotifyDetails: function fillAlsoNotifyDetails() {
      ...
      if (this.selectAlsoNotify) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-alsonotify-address?id=".concat(this.selectAlsoNotify)).then(function (response) {
          _this8.form.also_notify_address = response.data;
      ...
      if (this.mode === 'add') {
        this.form.post("/user/create-webdoc").then(function (response) {
          ...
          if (response.data && response.data.data.first_box && response.data.data.first_box.original && response.data.data.first_box.original.data && response.data.data.first_box.original.data.id) {
            _this9.existingData = response.data.data.first_box.original.data;
            if (_this9.generatePDFAfterSave && _this9.existingData && _this9.existingData.id) {
              _this9.generateAwbPDF(_this9.generatePDFAfterSave);
            }
            _this9.successMessage = '-e-AWB Saved in database -Pass';
          } else {
          ...
          _this9.main_error_msg = main_error_msg;
        });
    ...
    getAirwayBills: function getAirwayBills(status) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/get-airway-bills/".concat(status)).then(function (response) {
        _this10.data_items = response.data;
        console.log(response);
      })["catch"](function (error) {
    ...
    getAirWayBill: function getAirWayBill(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/airway-bill/".concat(id)).then(function (response) {
        if (response.data && response.data.id == id) {
          ...
          _this11.existingData.payment_info = _objectSpread(_objectSpread({}, _this11.defaultPaymentInfo), _this11.existingData.payment_info || {});
          // this.setDefaultValues();
          _this11.showAWBSection = true;
          _this11.awbError = null;
          _this11.openForm('update', _this11.existingData.id);
          if (_this11.existingData && _this11.existingData.consignment_data) {
            _this11.isConsignmentAdded = true;
          }
        } else {
          _this11.showAWBSection = false; // Hide if no data exists
    ...
    getAirWayBillForRealod: function getAirWayBillForRealod(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/airway-bill/".concat(id)).then(function (response) {
        ...
        _this12.showAWBSection = false;
        _this12.awbError = ((_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 404 ? "Air Waybill not found." : "";
      });
    },
    ...
    getAgent: function getAgent(company_id, branch_id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/agent-info").then(function (_ref6) {
        ...
        if (Array.isArray(data) && data.length > 0) {
          _this13.agent_information = data[0];
          _this13.iata_cass = {
            iata_agent_code: _this13.agent_information.iata_agent_code || null,
            iata_agent_cass: _this13.agent_information.iata_agent_cass || null
          };
        } else {
          _this13.agent_information = data;
        }
      })["catch"](function (error) {
    ...
    getCountry: function getCountry() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/user/get-country').then(function (_ref7) {
        var data = _ref7.data;
        _this14.countries = Object.keys(data).map(function (key) {
          return {
            value: key,
            text: data[key]
          };
    ...
    getOtherChargesCode: function getOtherChargesCode() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/user/other-charges').then(function (_ref8) {
        var data = _ref8.data;
        _this15.other_charges_code = Object.keys(data).map(function (key) {
          return {
            value: key,
            text: data[key]
          };
    ...
    getOCIData: function getOCIData() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get('/user/get-oci-data').then(function (_ref9) {
        ...
        if (data && data.oci_custom_info_identifier) {
          _this16.oci_data.oci_custom_info_identifier = Object.entries(data.oci_custom_info_identifier).map(function (_ref10) {
        ...
        if (data && data.identifiers) {
          _this16.oci_identifiers.identifiers = Object.entries(data.identifiers).map(function (_ref12) {
    ...
    addOrUpdateEntry: function addOrUpdateEntry(evt) {
      ...
      this.consignment_list.post("/user/get-consignment-error").then(function (response) {
        ...
        if (_this17.edit_entry_index !== null) {
          console.log("Updating entry at index", _this17.edit_entry_index, "with data:", updatedEntry);
        ...
        _this17.closeModal();
        console.log("Updated form entries:", _this17.form.entries);
    ...
    reloadPageWithContent: function reloadPageWithContent() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/user/airway-bill/".concat(awbId)).then(function (response) {
        _this21.existingData = response.data;
        if (_this21.existingData) {
          _this21.awbDetails = false;
          _this21.openForm('update', _this21.existingData.id);
          // this.$router.push({ path: `/edit-airway-bill/${awbId}`});
          _this21.location.reload();
          // this.$router.push({ path: `/edit-airway-bill/${awbId}` });
        } else {
          _this21.awbDetails = false;
        }
      })["catch"](function (error) {
        _this21.existingData = null;
