...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getAgent: function getAgent() {
      var _this = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/agent-info/").then(function (_ref2) {
        var data = _ref2.data;
        if (Array.isArray(data) && data.length > 0) {
          _this.agent_information = data[0];
          _this.iata_cass = {
            iata_agent_code: _this.agent_information.iata_agent_code || null,
            iata_agent_cass: _this.agent_information.iata_agent_cass || null
          };
        } else {
          _this.agent_information = data;
        }
    ...
    addCharge: function addCharge() {
      ...
      if (this.editIndex !== null) {
        this.form.charges[this.editIndex] = _objectSpread({}, this.other_charges);
        this.editIndex = null;
      } else {
        this.form.charges.push(_objectSpread({}, this.other_charges));
      }
    ...
    addOrUpdateEntry: function addOrUpdateEntry() {
      if (this.edit_entry_index !== null) {
        this.form.entries[this.edit_entry_index] = _objectSpread({}, this.consignment_list);
        this.edit_entry_index = null;
      } else {
        this.form.entries.push(_objectSpread({}, this.consignment_list));
      }
      this.closeModal();
      //clear consignment_list data
      for (var key in this.consignment_list) {
        if (_typeof(this.consignment_list[key]) === 'object') {
