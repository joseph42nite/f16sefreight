  ...
  methods: {
    ...
    getHouseWayBills: function getHouseWayBills(item) {
      ...
      if (!this.house_way_bills[key]) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/user/house-way-bills/".concat(String(item.awb_code), "/").concat(String(item.awb_no))).then(function (response) {
    ...
    getHouseWayBill: function getHouseWayBill(id) {
      var _this3 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/user/houseway-bill/".concat(id)).then(function (response) {
    ...
    allAirwayBill: function allAirwayBill() {
      var _this4 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/user/all-airway-bill").then(function (response) {
    ...
    getAirWayBill: function getAirWayBill(id) {
      var _this5 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/user/airway-bill/".concat(id)).then(function (response) {
    ...
    handleDeleteHouseBill: function handleDeleteHouseBill(id) {
      ...
      if (confirm("Are you sure you want to delete this house way bill?")) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/user/house-way-bills/".concat(id)).then(function () {
