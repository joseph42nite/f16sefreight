        ...
        if (arr_len) {
          for (var i in this.rate_data_copy) {
            ...
            if (this.is_allin_check) {
              ...
              currentData.Price += "".concat(this.selected_currency, " ").concat(((all_subcharge_amount + final_added_profit) / this.allin_amount).toFixed(2), "/kg ALLIN, AMS: ").concat(this.selected_currency, " ").concat((all_ams_amount / this.allin_amount).toFixed(2), " ALLIN");
            } else {
