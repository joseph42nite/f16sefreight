...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    startClaim() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].query("/inbox/threads/" + this.active.id + "/client-update/preview", {
        params: {
          stage: "claimed"
        }
      }).then(({
        ...
        this.busy = false;
        if (data.draft) this.claimDraft = data.draft;else this.claim(null);
      }).catch(() => {
        this.busy = false;
        this.claim(null);
      });
    ...
    claim(update) {
      this.busy = true;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].post("/inbox/threads/" + this.active.id + "/claim", update ? {
    ...
    decideUpdate(decision, values) {
      ...
      this.updateError = null;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].post("/inbox/threads/" + this.active.id + "/client-update", _objectSpread({
        stage: this.active.client_update.stage,
        decision
      }, values || {})).then(({
        data
      }) => {
        this.active = Object.assign({}, this.active, data);
      }).catch(e => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=script&lang=js":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created() {
    _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].get("/user/credits").then(({
      data
    }) => {
      this.data = data;
    }).catch(e => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    remove(uid) {
      ...
      if (doc && doc.jobId) _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/user/ocr-jobs/" + doc.jobId).catch(() => {});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    tooBig() {
      return this.files.reduce((sum, f) => sum + f.size, 0) > 25 * 1024 * 1024;
    }
  },
  methods: {
    attach(e) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "fx-btn fx-btn--primary fx-inbox__new",
    attrs: {
      "data-help": "new-mail"
    },
    on: {
  ...
  }, [_vm._v("+ New mail")])]), _vm._v(" "), _vm.writingNew ? _c("NewMail", {
    on: {
      close: function ($event) {
        _vm.writingNew = false;
      }
    }
  ...
  }, [_vm._v("Loading more…")]) : _vm._e()], 2)], 1), _vm._v(" "), _c("section", {
    ref: "convo",
    ...
    staticClass: "fx-update-card__title"
  }, [_vm._v("Client update ready — " + _vm._s(_vm.active.client_update.title))]), _vm._v(" "), _c("ClientUpdateEditor", {
    key: _vm.active.id + "-" + _vm.active.client_update.stage,
    attrs: {
      draft: _vm.active.client_update,
      busy: _vm.updateBusy,
      error: _vm.updateError
    },
    on: {
      send: function ($event) {
        return _vm.decideUpdate("send", $event);
      },
      skip: function ($event) {
        return _vm.decideUpdate("skip");
      }
    }
  })], 1) : _vm._e(), _vm._v(" "), _vm.claimDraft ? _c("div", {
    staticClass: "fx-modal",
    attrs: {
      role: "dialog",
      "aria-modal": "true",
    ...
    on: {
      send: function ($event) {
        return _vm.claim(_objectSpread({
          decision: "send"
        }, $event));
      },
      skip: function ($event) {
  ...
  }, [_vm._v("Cancel")])])], 1)])]) : _vm._e(), _vm._v(" "), _c("dl", {
...
var staticRenderFns = [function () {
  ...
  return _c("header", {
    ...
    staticClass: "fx-modal__title"
  }, [_vm._v("Claim and tell the client")])]);
}];
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=template&id=79d5038b":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=template&id=79d5038b ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
    staticClass: "fx-credits"
  }, [_vm.error ? _c("p", {
    staticClass: "fx-error",
    attrs: {
      role: "alert"
    }
  }, [_vm._v(_vm._s(_vm.error))]) : !_vm.data ? _c("p", {
    staticClass: "fx-muted"
  ...
  }, [_vm._v("Credits left")]), _vm._v(" "), _c("span", {
    staticClass: "fx-tile__value"
  }, [_vm._v(_vm._s(_vm.data.balance))]), _vm._v(" "), _vm.data.floor < 0 ? _c("p", {
    staticClass: "fx-muted fx-tile__detail"
  }, [_vm._v("can run down to " + _vm._s(_vm.data.floor) + " before AI reading stops")]) : _vm._e()]), _vm._v(" "), _c("div", {
    staticClass: "fx-tile"
  }, [_c("span", {
    staticClass: "fx-tile__label"
  }, [_vm._v("Used this month")]), _vm._v(" "), _c("span", {
    staticClass: "fx-tile__value"
    ...
    return _c("tr", {
      ...
      staticClass: "fx-num"
    }, [_vm._v(_vm._s(d.credits))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(d.user))]), _vm._v(" "), _c("td", [_c("Figure", {
      attrs: {
        value: d.created_at,
        kind: "dateTime"
      }
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v("Read as")]), _c("th", {
    staticClass: "fx-num",
    attrs: {
      scope: "col"
    }
  }, [_vm._v("Credits")]), _c("th", {
    attrs: {
      scope: "col"
    }
  }, [_vm._v("By")]), _c("th", {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _c("tr", {
      ...
      staticClass: "fx-muted"
    }, [_vm._v(" ⚠️ " + _vm._s(doc.warning))]) : _vm._e(), _vm._v(" "), doc.state === "ready" && doc.credits !== null ? _c("span", {
      staticClass: "fx-muted"
    }, [_vm._v(" · " + _vm._s(doc.credits) + " " + _vm._s(doc.credits === 1 ? "credit" : "credits"))]) : _vm._e(), _vm._v(" "), doc.state === "staged" && doc.readable === "scan" ? _c("span", {
      staticClass: "fx-staged__flag",
      attrs: {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/NewMail.vue?vue&type=template&id=aa53b6f4":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/NewMail.vue?vue&type=template&id=aa53b6f4 ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("New mail")]), _vm._v(" "), _c("button", {
    staticClass: "fx-btn fx-btn--ghost",
    attrs: {
      "aria-label": "Close",
      disabled: _vm.sending
    ...
    staticClass: "fx-newmail__sent",
    attrs: {
      role: "status"
    }
  }, [_vm._v("\n        Sent from " + _vm._s(_vm.sentFrom) + ". It appears in the list within about 2 minutes, once your mailbox syncs it back.\n      ")]) : [_c("label", {
    staticClass: "fx-field",
    attrs: {
      for: "new-mail-to"
    }
    ...
    attrs: {
      for: "new-mail-signature"
    }
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.includeSignature,
      expression: "includeSignature"
    }],
    attrs: {
      id: "new-mail-signature",
      type: "checkbox"
    },
    domProps: {
      checked: Array.isArray(_vm.includeSignature) ? _vm._i(_vm.includeSignature, null) > -1 : _vm.includeSignature
    },
    on: {
      change: function ($event) {
        var $$a = _vm.includeSignature,
          $$el = $event.target,
          $$c = $$el.checked ? true : false;
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.includeSignature = $$a.concat([$$v]));
          } else {
            $$i > -1 && (_vm.includeSignature = $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.includeSignature = $$c;
        }
      }
    }
  }), _vm._v(" "), _c("span", [_vm._v("Add my signature")])]), _vm._v(" "), _c("div", {
    staticClass: "fx-compose__attach"
  }, [_c("button", {
    staticClass: "fx-btn",
    attrs: {
    ...
    return _c("li", {
      ...
      staticClass: "fx-attachment__open"
    }, [_vm._v("📎 " + _vm._s(f.name))]), _vm._v(" "), _c("button", {
      staticClass: "fx-btn fx-btn--ghost",
      attrs: {
        type: "button",
        "aria-label": "Remove " + f.name,
      ...
      on: {
        click: function ($event) {
          return _vm.files.splice(i, 1);
        }
      }
    }, [_vm._v("✕")])]);
  }), 0) : _vm._e(), _vm._v(" "), _vm.tooBig ? _c("p", {
    staticClass: "fx-error",
    attrs: {
      role: "alert"
    }
  }, [_vm._v("The attachments come to more than 25 MB, the most a mail can carry.")]) : _vm._e(), _vm._v(" "), _vm.error ? _c("p", {
    staticClass: "fx-error",
    attrs: {
      role: "alert"
    }
  }, [_vm._v(_vm._s(_vm.error))]) : _vm._e()]], 2), _vm._v(" "), _c("footer", {
    staticClass: "fx-modal__foot"
  }, [_vm.sentFrom ? [_c("button", {
    staticClass: "fx-btn fx-btn--primary",
    on: {
      click: function ($event) {
        return _vm.$emit("close");
    ...
    staticClass: "fx-btn fx-btn--primary",
    attrs: {
      disabled: _vm.sending || !_vm.to.trim() || !_vm.subject.trim() || !_vm.body || _vm.tooBig
    },
    on: {
      click: _vm.send
    }
...
/***/ "./resources/js/src/view/pages/freight/components/CreditsPanel.vue":
/*!*************************************************************************!*\
  !*** ./resources/js/src/view/pages/freight/components/CreditsPanel.vue ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CreditsPanel_vue_vue_type_template_id_79d5038b__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CreditsPanel.vue?vue&type=template&id=79d5038b */ "./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=template&id=79d5038b");
/* harmony import */ var _CreditsPanel_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CreditsPanel.vue?vue&type=script&lang=js */ "./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=script&lang=js");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _CreditsPanel_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _CreditsPanel_vue_vue_type_template_id_79d5038b__WEBPACK_IMPORTED_MODULE_0__.render,
  _CreditsPanel_vue_vue_type_template_id_79d5038b__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/view/pages/freight/components/CreditsPanel.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _NewMail_vue_vue_type_template_id_aa53b6f4__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./NewMail.vue?vue&type=template&id=aa53b6f4 */ "./resources/js/src/view/pages/freight/components/NewMail.vue?vue&type=template&id=aa53b6f4");
/* harmony import */ var _NewMail_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./NewMail.vue?vue&type=script&lang=js */ "./resources/js/src/view/pages/freight/components/NewMail.vue?vue&type=script&lang=js");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _NewMail_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _NewMail_vue_vue_type_template_id_aa53b6f4__WEBPACK_IMPORTED_MODULE_0__.render,
  _NewMail_vue_vue_type_template_id_aa53b6f4__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/view/pages/freight/components/NewMail.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=script&lang=js":
/*!*************************************************************************************************!*\
  !*** ./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CreditsPanel_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CreditsPanel.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CreditsPanel_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NewMail_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NewMail.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/NewMail.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NewMail_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=template&id=79d5038b":
/*!*******************************************************************************************************!*\
  !*** ./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=template&id=79d5038b ***!
  \*******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CreditsPanel_vue_vue_type_template_id_79d5038b__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CreditsPanel_vue_vue_type_template_id_79d5038b__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CreditsPanel_vue_vue_type_template_id_79d5038b__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CreditsPanel.vue?vue&type=template&id=79d5038b */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/CreditsPanel.vue?vue&type=template&id=79d5038b");
...
/***/ "./resources/js/src/view/pages/freight/components/NewMail.vue?vue&type=template&id=aa53b6f4":
/*!**************************************************************************************************!*\
  !*** ./resources/js/src/view/pages/freight/components/NewMail.vue?vue&type=template&id=aa53b6f4 ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NewMail_vue_vue_type_template_id_aa53b6f4__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NewMail_vue_vue_type_template_id_aa53b6f4__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NewMail_vue_vue_type_template_id_aa53b6f4__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NewMail.vue?vue&type=template&id=aa53b6f4 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/freight/components/NewMail.vue?vue&type=template&id=aa53b6f4");
