...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getHousewayBills(status) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/get-houseway-bills/${status}`).then(response => {
    ...
    getHouseWayBill(id) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get(`/user/houseway-bill/${id}`).then(response => {
     ...
     */
    loadMasterOptions() {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get('/user/get-airway-bills/all').then(({
        data
      }) => {
