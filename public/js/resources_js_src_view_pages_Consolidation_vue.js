...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    converXml: function converXml(awb_no) {
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get("/waybill/".concat(awb_no)).then(function (_ref) {
        var data = _ref.data;
        console.log(data);
      });
    },
    ...
    getLocation: function getLocation() {
      var _this = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get("/get-location").then(function (_ref2) {
        var data = _ref2.data;
        _this.location = data;
      });
    },
    ...
    allHousewayBill: function allHousewayBill() {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get('/all-houseway-bill').then(function (response) {
    ...
    getAirWayBill: function getAirWayBill(id) {
      var _this4 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get("/airway-bill/".concat(id)).then(function (response) {
    ...
    getCountry: function getCountry() {
      var _this5 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get('/get-country').then(function (_ref3) {
        var data = _ref3.data;
    ...
    getAgent: function getAgent() {
      var _this6 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get("/agent-info/").then(function (_ref4) {
        var data = _ref4.data;
    ...
    getOCIData: function getOCIData() {
      var _this7 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].get('/get-oci-data').then(function (_ref5) {
        var data = _ref5.data;
...
var render = function render() {
  ...
  }, [_vm._v("Search")])], 1)])], 1), _vm._v(" "), _vm.hasSearchResults ? _c("div", [_c("hr", {
    staticClass: "hr"
  }), _vm._v(" "), _c("b-row", [_c("b-col", {
    attrs: {
      cols: "12"
  ...
  }, [_c("p", [_vm._v("No house waybill information found. Please use the UI above to add house waybills.")])]) : _vm._e()], 1)], 1)])]);
};
var staticRenderFns = [];
render._withStripped = true;
