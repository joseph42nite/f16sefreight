...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      this.form.post("/create-housewaybill").then(function (_ref) {
        var data = _ref.data;
  ...
  computed: {
    ...
    totalDueAgent: function totalDueAgent() {
      return this.charges.filter(function (charge) {
        return charge.due === 'Agent';
      }).reduce(function (total, charge) {
        return total + parseFloat(charge.amount || 0);
      }, 0).toFixed(2);
    },
    totalDueCarrier: function totalDueCarrier() {
      return this.charges.filter(function (charge) {
        return charge.due === 'Carrier';
      }).reduce(function (total, charge) {
        return total + parseFloat(charge.amount || 0);
      }, 0).toFixed(2);
    },
    totalCharges: function totalCharges() {
      return (this.weightCharge + parseFloat(this.taxes) + parseFloat(this.totalDueAgent) + parseFloat(this.totalDueCarrier)).toFixed(2);
    }
  },
  components: {
