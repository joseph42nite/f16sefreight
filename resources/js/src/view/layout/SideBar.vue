                        ...
                        <div class="sidebar__icon-wrap">
                            <img
                                :src="isActive(['/focus-air', '/house-way-bill', '/consolidation', '/edit-airway-bill', '/edit-houseway-bill'])
                                    ? '/media/custome/side-menu/3-active.png'
                                    : '/media/custome/side-menu/3.png'"
                                alt="Air Freight"
                            />
                        </div>
                    </li>
                        ...
                        <div class="sidebar__icon-wrap">
                            <img
                                :src="isActive('/message-log')
                                    ? '/media/custome/side-menu/4-active.png'
                                    : '/media/custome/side-menu/4.png'"
                                alt="Message Log"
                            />
                        </div>
                    </li>
                ...
                <router-link to="/rate" custom v-slot="{ navigate }">
                    ...
                    >
                        <div class="sidebar__icon-wrap">
                            <img
                                :src="isActive('/rate')
                                    ? '/media/custome/side-menu/5-active.png'
                                    : '/media/custome/side-menu/5.png'"
                                alt="Rate"
                            />
                        </div>
                    </li>
