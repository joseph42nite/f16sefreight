  ...
  methods: {
    ...
    getAirWayBill: function getAirWayBill(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/airway-bill/".concat(id)).then(function (response) {
        if (response.data && response.data.id == id) {
          ...
          _this9.showAWBSection = true; // Show message only if data exists
    ...
    getAirWayBillForRealod: function getAirWayBillForRealod(id) {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["default"].get("/airway-bill/".concat(id)).then(function (response) {
        ...
        _this10.showAWBSection = false;
        _this10.awbError = ((_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 404 ? "Air Waybill not found." : "Failed to fetch AWB details.";
      });
    },
    openForm: function openForm(mode) {
      ...
      if (mode === 'update' && id) {
        ...
        this.form.entries = Array.isArray(this.existingData.consignment_data) ? this.existingData.consignment_data : [this.existingData.consignment_data]; //for row you can use this code this is working 
